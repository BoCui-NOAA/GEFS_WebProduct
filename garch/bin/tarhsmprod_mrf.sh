...
>fname
for hr in 00 12 24 36 48 60 72 84 96 108 120 132 144 156 168 180 192 204 216 228 240 \
          252 264 276 288 300 312 324 336 348 360 372 384
do

echo "./drfmr.t00z.pgrbf$hr" >>fname
echo "./drfmr.t00z.sfluxgrbf$hr" >>fname
...
for hr in 00 12 24 36 48 60 72 84 96 108 120 132 144 156 168 
do

$COPYGB -g2 -x drfmr.t00z.pgrbf$hr /global/prs/pgbf$hr.$ymdh
cp drfmr.t00z.sfluxgrbf$hr         /global/prs/flxf$hr.$ymdh

done

for hr in 180 192 204 216 228 240 252 264 276 288 300 312 324 336 348 360 372 384
do
cp drfmr.t00z.pgrbf$hr /global/prs/pgbf$hr.$ymdh
cp drfmr.t00z.sfluxgrbf$hr         /global/prs/flxf$hr.$ymdh
done
