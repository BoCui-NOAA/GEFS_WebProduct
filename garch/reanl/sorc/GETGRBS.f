      subroutine getgrb(glb,jx,jy,cpgb,ifd,ilev,idate,ifh,iunit,
     *                  kpds,kgds)
...
c
      ...
      jens    = -1
      jpds(5) = ifd
c     jpds(6) = 105   ! U, V at 10m, T at 2m
      jpds(6) = 102   ! PRMSL
      jpds(7) = ilev
      if (iy.eq.0) then
       jpds(8) = 100
      ...
      jpds(9) = im
      jpds(10)= id 
c     jpds(11)= ih + 18 ! for 10m UV and 2m T
      jpds(11)= ih 
c     jpds(14)= ifh + 06 ! for 10m UV and 2m T
      jpds(14)= ifh 
c--------+----------+----------+----------+----------+----------+----------+--
