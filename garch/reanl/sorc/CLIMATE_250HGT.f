       ...
       do jj = 1, iy
        do ii = 1, ix
         ...
         if (ii.eq.50.and.jj.eq.25) then
          print *, 'aaa=',(aaa(len),len=1,ldat(imo))
         endif
         lmn=ldat(imo)/40
         lhmon=lmn/2 
         lcnt = 0
...
c      kpds(22)=0      
c      kpds(23)=2      
c      print *, "KPDS=", (kpds(jjj),jjj=1,20)
       call putgb(81,10512,kpds,kgds,lb,f1,iret)
c      kpds(16)=136      
c      kpds(17)=0       
ccc    for 250hPa * 100.0
ccc    for 500hPa * 100.0
ccc    for 1000hPa * 10.0
       call putgb(82,10512,kpds,kgds,lb,f2*100.,iret)
c      kpds(16)=137     
c      kpds(17)=0       
ccc    for 250hPa * 100000.0
ccc    for 500hPa * 100000.0
ccc    for 1000hPa * 10000.0
       call putgb(83,10512,kpds,kgds,lb,f3*100000.,iret)
