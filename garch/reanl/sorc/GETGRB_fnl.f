      subroutine getgrb(glb,jx,jy,cpgb,ifd,itype,ilev,idate,ifh,iunit,
     *                  kpds,kgds)
...
C               5. ifd ( field ID input )                                    C
C               6. itype ( field type input)                                 C
C               7. ilev ( level input )                                      C
C               8. idate ( YYMMDDHH input with Y2K option )                  C
C               9. ifh  ( forecast hours at idate )                          C
C              10. iunit ( read data unit)                                   C
C              11. kpds                                                      C
C              12. kgds                                                      C
C                                                                            C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c--------+----------+----------+----------+----------+----------+----------+--
      ...
      dimension kpds(200),kgds(200),kens(5),jpds(200),jgds(200)
...
c
      ...
      jpds(11)= ih 
      jpds(14)= ifh 
c     print *, 'JPDS=',(jpds(kkk),kkk=5,14)
c--------+----------+----------+----------+----------+----------+----------+--
