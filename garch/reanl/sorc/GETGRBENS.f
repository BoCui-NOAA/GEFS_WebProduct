      subroutine getgrbe(glb,cpgb,ifd,itp,ilev,idate,ifh,iunit)
...
c     dimension glb(144,73,10),data(mdata)               
      dimension glb(mdata,10),data(mdata)               
      dimension jlev(17)                 
      dimension iens2(10),iens3(10)
      character*2  cim(12)
