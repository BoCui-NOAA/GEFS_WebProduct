...
do
 ...
 case $fld in
  ...
  u500)  FLD=500UGRD;ifd=33;itp=100;ilv=500;isthr=0;fc2=1.0;fc3=10.0;;
  v500)  FLD=500VGRD;ifd=34;itp=100;ilv=500;isthr=0;fc2=1.0;fc3=10.0;;
  ...
  tmax)  FLD=TMAX;ifd=15;itp=105;ilv=2;isthr=18;fc2=10.0;fc3=100.0;;
  tmin)  FLD=TMIN;ifd=16;itp=105;ilv=2;isthr=18;fc2=10.0;fc3=100.0;;
