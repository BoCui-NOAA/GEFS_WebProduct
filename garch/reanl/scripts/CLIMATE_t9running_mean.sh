...
mkdir /ptmp/wx20yz/CDAS_t9
mkdir /ptmp/wx20yz/reanl_t9
cd /ptmp/wx20yz/reanl_t9
...
$HOME/reanl/exec/climate_t9running_mean <input >/ptmp/wx20yz/CDAS_9/${FLD}_t${IHR}z.output

cp pgrbmean  /ptmp/wx20yz/CDAS_t9/${FLD}_t${IHR}z.mean
cp pgrbstdv  /ptmp/wx20yz/CDAS_t9/${FLD}_t${IHR}z.stdv
#cp pgrbskew  /ptmp/wx20yz/CDAS_t9/$FLD.skew
