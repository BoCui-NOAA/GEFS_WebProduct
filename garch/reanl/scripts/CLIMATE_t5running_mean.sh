...
mkdir /ptmp/wx20yz/CDAS_t5
mkdir /ptmp/wx20yz/reanl_t5
cd /ptmp/wx20yz/reanl_t5

IHR=00

#for fld in t2m z500 u10m 
for fld in u10m 
do
...
$HOME/reanl/exec/climate_t5running_mean <input >/ptmp/wx20yz/CDAS_4/${FLD}_t${IHR}z.output

cp pgrbmean  /ptmp/wx20yz/CDAS_t5/${FLD}_t${IHR}z.mean
cp pgrbstdv  /ptmp/wx20yz/CDAS_t5/${FLD}_t${IHR}z.stdv
#cp pgrbskew  /ptmp/wx20yz/CDAS_t5/$FLD.skew
