...
mkdir /ptmp/wx20yz/CDAS_3
mkdir /ptmp/wx20yz/reanl_3
cd /ptmp/wx20yz/reanl_3

IHR=00

for fld in u850  v850 u500 v500 u250 v250      \
...
$HOME/reanl/exec/climate_ac_sd_3 <input >/ptmp/wx20yz/CDAS_3/${FLD}_t${IHR}z.output

cp pgrbmean  /ptmp/wx20yz/CDAS_3/${FLD}_t${IHR}z.mean
cp pgrbstdv  /ptmp/wx20yz/CDAS_3/${FLD}_t${IHR}z.stdv
#cp pgrbskew  /ptmp/wx20yz/CDAS_3/$FLD.skew

#cp grads_tmp.dat /ptmp/wx20yz/CDAS_3/${FLD}_grads.dat
