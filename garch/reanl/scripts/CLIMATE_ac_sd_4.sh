...
mkdir /ptmp/wx20yz/CDAS_4
mkdir /ptmp/wx20yz/reanl_4
cd /ptmp/wx20yz/reanl_4
...
$HOME/reanl/exec/climate_ac_sd_4 <input >/ptmp/wx20yz/CDAS_4/${FLD}_t${IHR}z.output

cp pgrbmean  /ptmp/wx20yz/CDAS_4/${FLD}_t${IHR}z.mean
cp pgrbstdv  /ptmp/wx20yz/CDAS_4/${FLD}_t${IHR}z.stdv
#cp pgrbskew  /ptmp/wx20yz/CDAS_4/$FLD.skew
