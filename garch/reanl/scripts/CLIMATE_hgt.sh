...
rm pgrbmean pgrbstdv pgrbskew
$HOME/reanl/exec/climate_hgt.exe <input
...
cp fort.71   $FLD.NOV
cp fort.72   $FLD.DEC
cp pgrbmean  $FLD.mean
cp pgrbstdv  $FLD.stdv
cp pgrbskew  $FLD.skew
...
#cp pgrbmean  /global/CDAS/$FLD.mean
#cp pgrbstdv  /global/CDAS/$FLD.stdv
#cp pgrbskew  /global/CDAS/$FLD.skew
