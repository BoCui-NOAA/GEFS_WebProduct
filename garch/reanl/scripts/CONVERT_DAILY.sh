...
do
 ...
 fmean=/nbns/global/wx20yz/CDAS_cyc/cmean.$CDATE
 fstdv=/nbns/global/wx20yz/CDAS_cyc/cstdv.$CDATE
 >$fmean
 >$fstdv
 ...
 do
  file1=/nbns/global/wx20yz/CDAS_cyc/${FLD}_t${HH}z.mean
  file2=/nbns/global/wx20yz/CDAS_cyc/${FLD}_t${HH}z.stdv
