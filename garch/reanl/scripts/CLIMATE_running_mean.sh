...
mkdir /ptmp/wx20yz/CDAS_rm
mkdir /ptmp/wx20yz/reanl_rm
cd /ptmp/wx20yz/reanl_rm
...
$HOME/reanl/exec/climate_running_mean <input >/ptmp/wx20yz/CDAS_4/${FLD}_t${IHR}z.output

cp pgrbmean  /ptmp/wx20yz/CDAS_rm/${FLD}_t${IHR}z.mean
cp pgrbstdv  /ptmp/wx20yz/CDAS_rm/${FLD}_t${IHR}z.stdv
#cp pgrbskew  /ptmp/wx20yz/CDAS_rm/$FLD.skew
