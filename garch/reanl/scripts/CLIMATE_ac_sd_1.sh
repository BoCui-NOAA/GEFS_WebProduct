...
mkdir /ptmp/wx20yz/CDAS_1
mkdir /ptmp/wx20yz/reanl_1
cd /ptmp/wx20yz/reanl_1
...
$HOME/reanl/exec/climate_ac_sd_1 <input >/ptmp/wx20yz/CDAS_1/${FLD}_t${IHR}z.output

cp pgrbmean  /ptmp/wx20yz/CDAS_1/${FLD}_t${IHR}z.mean
cp pgrbstdv  /ptmp/wx20yz/CDAS_1/${FLD}_t${IHR}z.stdv
#cp pgrbskew  /ptmp/wx20yz/CDAS_1/$FLD.skew
