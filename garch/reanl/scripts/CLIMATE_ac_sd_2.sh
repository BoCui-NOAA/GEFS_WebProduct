...
do
 ...
 $HOME/reanl/exec/climate_ac_sd_2 <input >/ptmp/wx20yz/CDAS/${FLD}_t${IHR}z.output

 cp pgrbmean  /ptmp/wx20yz/CDAS/${FLD}_t${IHR}z.mean
 cp pgrbstdv  /ptmp/wx20yz/CDAS/${FLD}_t${IHR}z.stdv
