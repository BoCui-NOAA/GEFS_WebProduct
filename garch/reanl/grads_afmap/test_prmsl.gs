...
'define hefi1 = sum(const(const(maskout(PRMSLmsl,PRMSLmsl-84.1),1),0,-u),e=1,e=20)'
'define lefi1 = sum(const(const(maskout(PRMSLmsl,PRMSLmsl-15.9),0),1,-u),e=1,e=20)'
...
'define hefi2 = sum(const(const(maskout(PRMSLmsl,PRMSLmsl-97.7),1),0,-u),e=1,e=20)'
'define lefi2 = sum(const(const(maskout(PRMSLmsl,PRMSLmsl-2.3),0),1,-u),e=1,e=20)'
...
'define hefi3 = sum(const(const(maskout(PRMSLmsl,PRMSLmsl-99.8),1),0,-u),e=1,e=20)'
'define lefi3 = sum(const(const(maskout(PRMSLmsl,PRMSLmsl-0.02),0),1,-u),e=1,e=20)'
...
'set string 1 c 7'
'set strsiz 0.24'
'draw string 5.5 8.2 Sea Level Pressure (PRMSL), 48-hour forecast'
'set strsiz 0.20'
'draw string 5.5 7.8 Ini. time:2012112800   Valid time:2012113000'
'set string 4 c 6'
'set strsiz 0.14'
...
'print'
'printim amap_na2012112800_48.gif gif x1100 y850 white'
'quit'
