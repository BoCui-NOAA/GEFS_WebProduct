...
do
 ...
 cp /lfs/h1/ops/prod/com/naefs/v6.1/cmce.$YMD/${CYC}/pgrb2ap5_bc/cmc_geavg.t${CYC}z.pgrb2a.0p50_bcf${FHR} .
 ...
 cp /lfs/h1/ops/prod/com/naefs/v6.1/cmce.$YMD/${CYC}/pgrb2ap5_bc/cmc_gespr.t${CYC}z.pgrb2a.0p50_bcf${FHR} .
 ...
 afile=/lfs/h1/ops/prod/com/naefs/v6.1/gefs.$YMDM2/${CYC}/pgrb2ap5/ncepcmc_glbanl.t${CYC}z.pgrb2a.0p50_mdf000
