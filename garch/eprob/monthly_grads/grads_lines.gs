...
grfile='NH500h_monthly_rpss_eval.gr'
say grfile
'enable print 'grfile
'reset'
'set vpage 0 11 4.0 8.5'
'set grads off'
ts=00Z01DEC99
te=00Z01AUG08
ts=00Z01JAN07
...
'set ccolor 1'
'd 'var1''
'draw title Monthly Average for NH 500hPa Height, 5-day forecasts'
'draw ylab RPS scores'

'set strsiz 0.12'
'set string 1 tl 6'
'draw string 9.0 1.2 RPSS='pranh500
'set string 2 tl 6'
*'draw string 9.0 1.2 EVAL='prbnh500
...
'set ccolor 1'
'd 'var2''
*'draw title Monthly Ave. (NH 500hPa Height, 5-day forecasts)'
'draw ylab EV (1:10 ratio)'
