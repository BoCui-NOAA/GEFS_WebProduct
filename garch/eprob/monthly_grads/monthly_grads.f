...
c     read (10,200)
      do ic = 1, icyc
c     read (10,201,end=1000) (dat(ic,i),i=1,6)
      read (10,201,end=1000) (dat(ic,i),i=1,2)
c     write (*,201) (dat(ic,i),i=1,6)
      write (*,201) (dat(ic,i),i=1,2)
      enddo
 1000 continue
 200  format(1x)                              
c201  format(6x,6(f7.4))
 201  format(6x,2(e14.8))
