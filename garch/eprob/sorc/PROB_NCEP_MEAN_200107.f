...
C
      parameter (nm=NMEM,istep=NSTEP,nr=6,nb=11)
C     parameter (nm=15,nr=6,nb=11)
...
cccc notes from Yuejian Zhu (05/11/2005)
          ctmp =float((ii-1)*(nm-1))/100.0-anp0(ii,ndom)/fcp0(ii,ndom)
...
c
         ...
         write (*,'(14f7.4)') (hr(i),i=1,10)
         write (*,'(10f7.4)') (fa(i),i=1,10)
