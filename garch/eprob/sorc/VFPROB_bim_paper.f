...
c--------+---------+---------+---------+---------+---------+---------+---------+
       ...
       do ng = 1, ngrid
        read (nuc) clip
ccc   print out the grid point values for bim paper
ccc   grid point 1:  55N 175E    --->  ng = 2087
        if (ng.eq.2087) then
         print *, ' === 9 climatological data at 55N,175E ==='
         print *, 'Date=',ndate,' fcst hours = ',nfcst*12
         write(*,881) (clip(n),n=10,90,10)
         write(*,881) (fcst(ng,n),n=1,20)  
         write(*,881) anl(ng),fmrf(ng),ft62(ng),favn(ng)
        endif
ccc   grid point 2:  45N 175E    --->  ng = 2663
        if (ng.eq.2663) then
         print *, ' === 9 climatological data at 45N,175E ==='
         print *, 'Date=',ndate,' fcst hours = ',nfcst*12
         write(*,881) (clip(n),n=10,90,10)
         write(*,881) (fcst(ng,n),n=1,20)  
         write(*,881) anl(ng),fmrf(ng),ft62(ng),favn(ng)
        endif
ccc   grid point 3:  50N 195E    --->  ng = 2383
        if (ng.eq.2383) then
         print *, ' === 9 climatological data at 50N,195E ==='
         print *, 'Date=',ndate,' fcst hours = ',nfcst*12
         write(*,881) (clip(n),n=10,90,10)
         write(*,881) (fcst(ng,n),n=1,20)  
         write(*,881) anl(ng),fmrf(ng),ft62(ng),favn(ng)
        endif
ccc   grid point 4:  40N 195E    --->  ng = 2959
        if (ng.eq.2959) then
         print *, ' === 9 climatological data at 40N,195E ==='
         print *, 'Date=',ndate,' fcst hours = ',nfcst*12
         write(*,881) (clip(n),n=10,90,10)
         write(*,881) (fcst(ng,n),n=1,20)  
         write(*,881) anl(ng),fmrf(ng),ft62(ng),favn(ng)
...
c
 882  format(10f8.2)
        if (ng.eq.2087) then
         print *, ' === histogrand for data at 55N,175E ==='
         write(*,882) (fcp(ng,nb),nb=1,10)
        endif
        if (ng.eq.2663) then
         print *, ' === histogrand for data at 45N,175E ==='
         write(*,882) (fcp(ng,nb),nb=1,10)
        endif
        if (ng.eq.2383) then
         print *, ' === histogrand for data at 50N,195E ==='
         write(*,882) (fcp(ng,nb),nb=1,10)
        endif
        if (ng.eq.2959) then
         print *, ' === histogrand for data at 40N,195E ==='
         write(*,882) (fcp(ng,nb),nb=1,10)
        endif
