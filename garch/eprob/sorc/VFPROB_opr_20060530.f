...
c     nens=10     ; number of ensemble members
...
c
      ...
      dimension fcp100(11,3),fcpg(11,3),fcpgn(11,3),tfcpg(3)
...
c      data file1/'/ensemble/noscrub/yan.luo/cdas/500HGT.'/
c      data file2/'/ensemble/noscrub/yan.luo/cdas/500HGT.'/
c      data pfile/'/ensemble/save/yan.luo/eprob/scripts/prob_nh.dat'/
c--------+---------+---------+---------+---------+---------+---------+---------+
...
c--------+---------+---------+---------+---------+---------+---------+---------+
     ...
     .     status='unknown',err=1001)
      ...
      open(unit=18,file='dis_avg.dat',form='formatted',err=1003)
...
c   10 ensemble number will create 11 possibility ( categories )
c      fcpgn is the region account average numbers for 11 categories 
c      for each leading time, sum. of these 11 numbers are equal to 1.0
c
...
c      modified by Yuejian Zhu (11/20/00)
       ...
       read(18,224) (fcpg(icat,1),icat=1,11)
       read(18,224) (fcpg(icat,2),icat=1,11)
       read(18,224) (fcpg(icat,3),icat=1,11)
       ...
       write(*,222) (fcpgn(icat,1),icat=1,11)
       write(*,222) (fcpgn(icat,2),icat=1,11)
       write(*,222) (fcpgn(icat,3),icat=1,11)
...
c
       ...
       write(*,222) (fcpgn(icat,2),icat=1,11)
       write(*,222) (fcpgn(icat,3),icat=1,11)
       write(58,224) (fcpgn(icat,1),icat=1,11)
       write(58,224) (fcpgn(icat,2),icat=1,11)
       write(58,224) (fcpgn(icat,3),icat=1,11)
