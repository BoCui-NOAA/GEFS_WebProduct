...
mkdir $PTMP/$LOGNAME/mmap
cd    $PTMP/$LOGNAME/mmap
...
sed -e "s/IYMDH/$CDATE/" \
    ...
    -e "s/VYMD31/$VYMD31/" \
    -e "s/VYMD32/$VYMD32/" \
    $SHOME/$LOGNAME/eprob/scripts/mmap.gs >mmap.gs
...
WWWDIR=/usr/people/emc/htdocs/gmb/wx20cb/mmap                             
...
do
 ...
 $SHOME/$LOGNAME/xbin/ftpemcrzdm emcrzdm put $RZDMDIR/$CDATE $PTMP/$LOGNAME/mmap mmap_${CDATE}_$fhr.png
done
...
sed -e "s/YYYYMMDD01/$KYMD01/g" \
    ...
    $SHOME/$LOGNAME/eprob/scripts/relpred.html >relpred.html
...
$SHOME/$LOGNAME/xbin/ftpemcrzdm emcrzdm put $RZDMDIR $PTMP/$LOGNAME/mmap relpred.html
