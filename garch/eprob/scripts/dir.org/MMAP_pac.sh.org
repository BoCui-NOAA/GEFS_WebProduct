...
sed -e "s/IYMDH/$CDATE/" \
    ...
    -e "s/VYMD31/$VYMD31/" \
    -e "s/VYMD32/$VYMD32/" \
    $SHOME/$LOGNAME/eprob/scripts/mmap_pac.gs >mmap.gs
...
do
 ...
 $SHOME/$LOGNAME/xbin/ftpemcrzdm emcrzdm put $RZDMDIR/$CDATE $tmpdir mmap_${CDATE}_${fhr}_pac.png
done
...
sed -e "s/YYYYMMDD01/$KYMD01/g" \
    ...
    $SHOME/$LOGNAME/eprob/scripts/relpred_pac.html >relpred.html
...
$SHOME/$LOGNAME/xbin/ftpemcrzdm emcrzdm put $RZDMDIR $tmpdir relpred_pac.html
