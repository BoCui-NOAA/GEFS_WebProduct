...
tmpdir=$GTMP/$LOGNAME/eprob_14m_f
...
pgb=$GLOBAL/ens/z500_ncep_fnl.$YYYY
pgi=z500_ncep_fnl.$YYYY\i
$windex $pgb $pgi
var=" cfilea(1,1)='$pgb',cfilea(2,1)='$pgi', "
echo "$var"
echo "$var" >> input2
nstepm1=`expr $fhours / 12` ; echo $nstepm1
nstep=`expr $nstepm1 + 1` ; echo $nstep
kcnt=1
...
cp prob.ens $SHOME/$LOGNAME/global/vfprob/PROB14.$ymdh
