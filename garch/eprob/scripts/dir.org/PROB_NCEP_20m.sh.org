...
export tmpdir=$GTMP/$LOGNAME/vfprob
...
export script=$SHOME/$LOGNAME/eprob/scripts
export bindir=$SHOME/$LOGNAME/bin
export datdir=$SHOME/$LOGNAME/eprob/data
...
#$SHOME/$LOGNAME/save/eprob/exec/prob_opr_20060530 <param
$SHOME/$LOGNAME//eprob/exec/prob_opr_20m <param
