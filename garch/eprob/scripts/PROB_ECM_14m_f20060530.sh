...
###
###   This job will calculate the probability of ECM ensemble          
###    -------- New at 03/19/2002
###
...
tmpdir=$GTMP/yan.luo/vfprob_ecm14m_f
...
cat $GLOBAL/ecm_ens/z500.$ymdh >z500.$ymdh
pgb=z500.$ymdh
pgi=z500i.$ymdh
$windex  $pgb $pgi
...
pgb=$GLOBAL/ens/z500_ecm_fnl.$YYYY
pgi=z500_ecm_fnl.$YYYY\i
$windex $pgb $pgi
...
$SHOME/yan.luo/eprob/exec/VFPROB_ecm14m_f20060530 <param

cp prob.ens $SHOME/yan.luo/global/vfprob/PROB14e.$ymdh
