...
c     CALL W3LOG('$S97118.73','ENSPPF')
      CALL W3TAGB('ENSPPF',0097,0118,0073,'NP20   ')
...
c      if (jpds(14).gt.240) then
c       jpds(13)=12
c       jpds(11)=jpds(11)/jpds(13)
c       jpds(14)=jpds(14)/12
c      endif
       jens(2)=kens2(m)
       jens(3)=kens3(m)
...
c        kpds(14)=kpds(14)*kpds(13)
c        kpds(15)=kpds(15)*kpds(13)
         do ii=1,10512
         ff(ii,icnt)=f(ii)
         enddo
ccc
