...
ccc....
ccc   for T12Z forecasting 72 - 240 hours period ( AVN running )
ccc....
        if (kpds(14).gt.66.and.kpds(14).lt.240) then
         ihrs=kpds(15)-kpds(14)
         print *,' ihrs=',ihrs
         if (ihrs.eq.24) then
          do i=1,kkf
             f2(i) = f2(i) - f1(i)
...
ccc....
ccc   for T12Z forecasting at 240-264 hours period (AVN running)
ccc....
       if (kpds(14).eq.264) then
         print *,' kpds14=',kpds(14)
          do i=1,kkf
             f2(i) = f2(i)*24.*3600.-f1(i)
             if (f2(i).lt.0.0) then
                f2(i)=0.0
             endif
          enddo
...
ccc....
ccc   for T12Z forecasting after 264 hours (AVN running )
ccc....
        if (kpds(14).gt.264) then
         print *,' kpds14=',kpds(14)
         if (mod(kpds(14),24).eq.0) then
          do i=1,kkf
             f2(i) = f2(i)*24.*3600.0-f1(i)
             if (f2(i).lt.0.0) then
              f2(i)=0.0
             endif
          enddo
...
ccc....
ccc   for CTL and PAIRS forecasting upto 240 hours
ccc....
       if (kpds(14).lt.240) then
         ihrs=kpds(15)-kpds(14)
         print *,' ihrs=',ihrs
         if (ihrs.eq.24) then
          do i=1,kkf
...
ccc....
ccc   for CTL and PAIRS forecasting at 240-264 hours period
ccc....
       if (kpds(14).eq.264) then
...
ccc....
ccc   for CTL and PAIRS forecasting after 264 hours         
ccc....
       if (kpds(14).gt.264) then
ccc   kpds(15) greater than 252 is not present
ccc      ihrs=kpds(15)-kpds(14)
