...
TMPDIR=$PTMP/$LOGNAME/ENS_bcbk$hh

mkdir $TMPDIR
cd $TMPDIR

hpsstar get /1year/hpssprod/runhistory/rh2010/$yyyymm/$yyyymm$dd/com_gens_prod_gefs.$yyyymm$dd\_$hh.pgrba_bc.tar
...
if [ $fhr -eq 00 ]; then
 ...
 file=$TMPDIR/pgrba_bc/ge$num.t${hh}z.pgrba_bcf$fhr 
fi
