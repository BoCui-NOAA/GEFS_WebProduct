...
TMPDIR=$PTMP/$LOGNAME/ENS_FNMOC_BC_$hh

mkdir $TMPDIR
cd $TMPDIR

#hpsstar get /hpssuser/g01/wx20cb/FNMOC/$yyyymm/mevf_fnmoc.$CDATE.tar
#hpsstar get /hpssuser/g01/wx20cb/FNMOC/200905/mevf_fnmoc.$CDATE.tar

ENSADD=$SHOME/$LOGNAME/earch/scripts/ensadd.sh
odir=/com/fnmoc/prod            
ndir=$GLOBAL/fno_ens_bc
...
if [ "$num" = "ctl" ]; then
 ...
 file=$TMPDIR/fens.$yyyymm$dd/$hh/pgrba_bc/fnmoc_ge$num.t${hh}z.pgrba_bcf$fhr 
# file=/climate/noscrub/wx22yz/com/fnmoc/dev/fens.$yyyymm$dd/$hh/pgrba_bc/fnmoc_ge$num.t${hh}z.pgrba_bcf$fhr 
#file=/global/hires/wx22yz/com/fnmoc/dev/fens.$yyyymm$dd/$hh/pgrba_bc/fnmoc_ge$num.t${hh}z.pgrba_bcf$fhr 
 file=/global/hires/wx22yz/com/gens/dev/fens.$yyyymm$dd/$hh/pgrba_bc/fnmoc_ge$num.t${hh}z.pgrba_bcf$fhr 
 file=/com/gens/prod/fens.$yyyymm$dd/$hh/pgrba_bc/fnmoc_ge$num.t${hh}z.pgrba_bcf$fhr 
fi
