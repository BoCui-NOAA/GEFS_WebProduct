...
do
 ...
 ens=s
 copygb -xg2 /nbns/global/wx23bk/gfs/pgbf00.gfs.$FDATE fcst.dat             
 ...
 if [ "$ens" = "s" ]; then
 copygb -xg2 /nbns/global/wx23bk/gfs/pgbf${FHR}.gfs.$CDATE fcst.dat
 else
 cp /global/pru/pgbf${FHR}.$CDATE fcst.dat
 fi
