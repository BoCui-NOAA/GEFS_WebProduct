...
### experiment c ( period 07/15/00-??/??/00 - T170 exp)
fdir=/gpfsuser/g01/wx23sm/para_exp/clw01
ddir=/gpfsuser/g01/wx23sm/para_exp/clw01

### experiment c ( period 07/28/99-0901/99 )
#fdir=/gpfsuser/g01/wx23sm/para_exp/clw3
#ddir=/gpfsuser/g01/wx23sm/para_exp/clw3

### experiment f ( filter for orograph )###
#fdir=/gpfsuser/g01/wx23sm/para_exp/flto
#ddir=/gpfsuser/g01/wx23sm/para_exp/flto

### experiment g ( old gravity wave drag - less important )###
#fdir=/gpfsuser/g01/wx23sm/para_exp/gwd 
#ddir=/gpfsuser/g01/wx23sm/para_exp/gwd

### experiment n ( new gravity wave drag - less important )###
#fdir=/gpfsuser/g01/wx23sm/para_exp/gwdn 
#ddir=/gpfsuser/g01/wx23sm/para_exp/gwdn

### experiment c ( old cloud water liquid scheme )###
#fdir=/gpfsuser/g01/wx23sm/para_exp/clw  
#ddir=/gpfsuser/g01/wx23sm/para_exp/clw 

### experiment o ( New control - reduce grid scheme )###
#fdir=/nfsptmp/wx23sm/para_exp/cnt          
#ddir=/nfsptmp/wx23sm/para_exp/cnt           

### experiment 1 ###
#fdir=/nfsuser/g01/wx23sm/data/para_test/cn1
#dir=/nfsuser/g01/wx23sm/data/para_test/cn1

### experiment 2 ###
#dir=/nfsuser/g01/wx23sm/data/para_test/cn2
#dir=/nfsuser/g01/wx23sm/data/para_test/cn2

### experiment g1 ( gwd with reduce grid exp 01 ) #
#fdir=/nfsptmp/wx23bk/para_exp/gwd01             
#ddir=/nfsptmp/wx23bk/para_exp/gwd01             

### experiment c1 ( 1st clw with reduce grid )#
#fdir=/nfsptmp/wx23sm/clw1                       
#ddir=/nfsptmp/wx23sm/clw1                       
#fdir=/gpfsuser/g01/wx23sm/para_exp/clw1                       
#ddir=/gpfsuser/g01/wx23sm/para_exp/clw1                       
...
#  GDAS) DIRandFile=$ddir/pgbanl.$pymdh;Sfile=$fn$anl.$pymdh;FF=cfilea;; 
#  FCST) DIRandFile=$fdir/$newfile.$fymdh;Sfile=$fn$fct.$fymdh;FF=cfilef;; 
  esac
...
cat scores.out 
cp scores.out /global/tscore/SCORES$pr.$stymd
stymd=`expr $stymd + 1`
