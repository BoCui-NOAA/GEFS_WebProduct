...
if [ $# -lt 2 ]; then
 echo "Usage: $0 need yyyymmdd, [06/18] "
 echo "       e.g.: vrfyex_avn.sh 20010601 06"
 exit 8      
else
 stymd=$1
 edymd=$1
...
#/nfsuser/g01/wx20yz/gvrfy/exec/vrfy_avn  <input0  2>/dev/null
/nfsuser/g01/wx20yz/gvrfy/exec/vrfy_0006_avn  <input0  2>/dev/null
