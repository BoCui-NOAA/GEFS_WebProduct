...
#  cat z1000.$pymdh z500.$pymdh >fnl.$pymdh
#  $windex fnl.$pymdh fnl.$pymdh.index
   cat z1000.$pymdh z500.$pymdh >$Sfile     
...
/nfsuser/g01/wx20yz/gvrfy/exec/vrfy_0006_dao  <input0  2>/dev/null
