...
cat <<paramEOF >input1
&namin  
 ihem=1,la1=5,la2=29,lo1=1,lo2=144,l1=5,l2=28,nhrs=$nh,nvhrs=$ih,
...
/    
 &namin  
 ihem=2,la1=45,la2=69,lo1=1,lo2=144,l1=45,l2=68,nhrs=$nh,nvhrs=$ih,
 ifd=7,ilv=1000,iclim=$iclime,ic=0,
 /    
 &namin  
 ihem=2,la1=45,la2=69,lo1=1,lo2=144,l1=45,l2=68,nhrs=$nh,nvhrs=$ih,
 ...
 ifd=33,ilv=850,iclim=$iclimt,ic=0,
 /    
 &namin
 ihem=3,la1=29,la2=45,lo1=1,lo2=144,l1=29,l2=44,nhrs=$nh,nvhrs=$ih,
 ifd=34,ilv=850,iclim=$iclimt,ic=0,
 /    
 &namin
 ihem=3,la1=29,la2=45,lo1=1,lo2=144,l1=29,l2=44,nhrs=$nh,nvhrs=$ih,
 ifd=101,ilv=850,iclim=$iclimt,ic=0,
 /    
 &namin
 ihem=3,la1=29,la2=45,lo1=1,lo2=144,l1=29,l2=44,nhrs=$nh,nvhrs=$ih,
 ifd=102,ilv=850,iclim=$iclimt,ic=0,
 /    
 &namin
 ihem=3,la1=29,la2=45,lo1=1,lo2=144,l1=29,l2=44,nhrs=$nh,nvhrs=$ih,
 ifd=33,ilv=200,iclim=$iclimt,ic=0,
 /    
 &namin
 ihem=3,la1=29,la2=45,lo1=1,lo2=144,l1=29,l2=44,nhrs=$nh,nvhrs=$ih,
 ifd=34,ilv=200,iclim=$iclimt,ic=0,
 /    
 &namin
 ihem=3,la1=29,la2=45,lo1=1,lo2=144,l1=29,l2=44,nhrs=$nh,nvhrs=$ih,
 ifd=101,ilv=200,iclim=$iclimt,ic=0,
 /    
 &namin
 ihem=3,la1=29,la2=45,lo1=1,lo2=144,l1=29,l2=44,nhrs=$nh,nvhrs=$ih,
 ifd=102,ilv=200,iclim=$iclimt,ic=0,
 /    
paramEOF
...
/nfsuser/g01/wx20yz/gvrfy/exec/vrfy_0301  <input0  2>/dev/null
       
cat scores.out >/nbns/global/wx20yz/vrfy_fitwav/SCORESo.$stymd\00
