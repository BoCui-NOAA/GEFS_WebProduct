...
cat <<paramEOF >input1
 ...
 /     
 &namin
 ihem=3,la1=29,la2=45,lo1=1,lo2=144,l1=29,l2=44,nhrs=120,
...
#assign -R
#### results output assigment ###############################
#assign -a /global/vrfy/SCORES$pr.$stymd               fort.81
#assign -a monitr$pr.$stymd                            fort.84
 
ls -l pgbf*

/nfsuser/g01/wx20yz/gvrfy/sorc/vrfy  <input0  2>/dev/null
