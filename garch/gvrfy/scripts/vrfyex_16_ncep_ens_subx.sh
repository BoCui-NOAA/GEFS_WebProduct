...
if [ "$pr" = "subx" ]; then
 ...
 fdir=/ensemble/noscrub/Eric.Sinsky/GEFS_output/SubX_realtime_new
 ddir=$GLOBAL/ENS   
 fn=
 anl=
 fct=
...
cat scores.out 
cp scores.out /ensemble/noscrub/Yan.Luo/vrfy_new/SCORES$pr.${stymd}subx
