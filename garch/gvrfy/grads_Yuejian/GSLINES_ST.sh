...
sed -e "s/*OPENFILE1/'open prEXPID1.ctl'/" \
    ...
    $HOME/gvrfy/grads/grads_lines_pub_ST.gs  >$GDIR/grads_lines.gs

sed -e "s/*OPENFILE1/'open prEXPID1.ctl'/" \
    -e "s/*LINES/lines=1/"                 \
    -e "s/*FDAYS/fdays=$PFDAYS/"           \
    -e "s/*DVAR1/'d t1'frms''/"            \
    $HOME/gvrfy/grads/grads_die_pub_ST.gs  >$GDIR/grads_die.gs
...
sed -e "s/*OPENFILE1/'open prEXPID1.ctl'/" \
    ...
    $HOME/gvrfy/grads/grads_lines_pub_ST.gs  >$GDIR/grads_lines.gs
#   $HOME/gvrfy/grads/grads_lines_VRFY03.gs  >$GDIR/grads_lines.gs
...
sed -e "s/*OPENFILE1/'open prEXPID1.ctl'/" \
    ...
    -e "s/*DVAR4/'d t4'frms''/"            \
    $HOME/gvrfy/grads/grads_die_pub_ST.gs  >$GDIR/grads_die.gs
#   $HOME/gvrfy/grads/grads_die_VRFY03.gs  >$GDIR/grads_die.gs
