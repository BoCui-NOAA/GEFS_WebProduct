...
#set -x
GDIR=$GTMP/$LOGNAME/grads_VRFY02   
mkdir -p $GDIR
...
$SHOME/$LOGNAME/gvrfy/grads/readin2grads.sh $STYMD $EDYMD $EXPID $FDAYS $SDIR $GDIR $GEXPID

sed -e "s/EXPID/$GEXPID/" \
    -e "s/CYMDH/$CYMDH/" \
    $SHOME/$LOGNAME/gvrfy/grads/run_4_grads.ctl > pr$GEXPID.ctl    
...
RZDMDIR=/home/people/emc/www/htdocs/gmb/yzhu/GFS_VRFY02
