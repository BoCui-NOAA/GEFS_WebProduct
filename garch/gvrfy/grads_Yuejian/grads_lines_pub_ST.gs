...
'clear'
*
* NH & SH 50 mb geopotential height (Z)
*
regs=1
rege=2
...
var='ac'reg''
say var
grfile=''greg'50z_'istday'days_ac_rms.gr'
say grfile
'enable print 'grfile
'reset'
...
'draw title 'titreg' 50 hPa Geopotential Height at day 'istday' \ for 'ts' - 'te' '
'draw ylab AC scores'
...
*
* TR 100 mb U RMS & 100 mb V RMS & 100 mb SPD RMS & 100 mb VTR RMS
*
...
grfile='tr100'fnam'_'istday'days_ac_rms.gr'
say grfile
'enable print 'grfile
'reset'
'set vpage 0.2 11 3.8 8.5'
...
'set cmark 6'
*DVAR6
'draw title TROPICAL 100 hPa 'titnam' at day 'istday' \ for 'ts' - 'te''
'draw ylab AC scores'
...
*
* TR 50 mb U RMS & 50 mb V RMS & 50 mb SPD RMS & 50 mb VTR RMS
*
...
grfile='tr50'fnam'_'istday'days_ac_rms.gr'
say grfile
'enable print 'grfile
'reset'
'set vpage 0.2 11 3.8 8.5'
...
'draw title TROPICAL 50 hPa 'titnam' at day 'istday' \ for 'ts' - 'te''
'draw ylab AC scores'
...
if(iday=4);ymin=0.9;endif;
if(iday=5);ymin=0.8;endif;
if(iday=6);ymin=0.8;endif;
if(iday=7);ymin=0.8;endif;
if(iday=8);ymin=0.8;endif;
if(iday=9);ymin=0.8;endif;
...
if(iday=1);rmin=5.0;endif;
if(iday=2);rmin=5.0;endif;
...
if(iday=4);rmax=50.;endif;
if(iday=5);rmax=60.;endif;
if(iday=6);rmax=80.;endif;
if(iday=7);rmax=100.;endif;
