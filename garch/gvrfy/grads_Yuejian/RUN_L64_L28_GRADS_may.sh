...
case $ICNT in
  1) EXPID1=$EXPID;SDIR=${SDIR_1};GEXPID1=GFSs;;
  2) EXPID2=$EXPID;SDIR=${SDIR_2};GEXPID2=190h;;
  3) EXPID3=$EXPID;SDIR=${SDIR_3};GEXPID3=126c;;
  4) EXPID4=$EXPID;SDIR=${SDIR_4};GEXPID4=126h;;
...
RZDMDIR=/home/people/emc/www/htdocs/gmb/yzhu/exp/L64_L28   
RZDMDIR=/home/people/emc/www/htdocs/gmb/yzhu/exp/T126L28_200711
RZDMDIR=/home/people/emc/www/htdocs/gmb/yzhu/exp/TmmmLnn_200705
