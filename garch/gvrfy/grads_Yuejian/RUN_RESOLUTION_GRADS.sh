...
case $ICNT in
  1) EXPID1=$EXPID;SDIR=${SDIR_1};GEXPID1=126d4;;
  2) EXPID2=$EXPID;SDIR=${SDIR_2};GEXPID2=190d8;;
  3) EXPID3=$EXPID;SDIR=${SDIR_3};GEXPID3=126d8;;
  4) EXPID4=$EXPID;SDIR=${SDIR_4};GEXPID4=382d8;;
