...
if(flds=1);'draw title NH 100 mb Height ( wave 'wtit' )';endif
if(flds=2);'draw title SH 100 mb Height ( wave 'wtit' )';endif
if(flds=3);'draw title NH 50 mb Height ( wave 'wtit' )';endif
if(flds=4);'draw title SH 50 mb Height ( wave 'wtit' )';endif
if(flds=5);'draw title Tropical 100 mb wind(u) ( wave 'wtit' )';endif
if(flds=6);'draw title Tropical 100 mb wind(v) ( wave 'wtit' )';endif
if(flds=7);'draw title Tropical 100 mb wind spd( wave 'wtit' )';endif
if(flds=8);'draw title Tropical 50 mb wind(u) ( wave 'wtit' )';endif
if(flds=9);'draw title Tropical 50 mb wind(v) ( wave 'wtit' )';endif
if(flds=10);'draw title Tropical 50 mb wind spd( wave 'wtit' )';endif
if(flds=11);'draw title NH 100 mb Height ('utit') )';endif
if(flds=12);'draw title SH 100 mb Height ('utit') )';endif
if(flds=13);'draw title NH 50 mb Height ('utit') )';endif
if(flds=14);'draw title SH 50 mb Height ('utit') )';endif
if(flds=15);'draw title Tropical wind(U) at 100 mb ('utit') )';endif
if(flds=16);'draw title Tropical wind(V) at 100 mb ('utit') )';endif
if(flds=17);'draw title Tropical wind spd at 100 mb ('utit') )';endif
if(flds=18);'draw title Tropical wind vtr at 100 mb ('utit') )';endif
if(flds=19);'draw title Tropical wind(U) at 50 mb ('utit') )';endif
if(flds=20);'draw title Tropical wind(V) at 50 mb ('utit') )';endif
if(flds=21);'draw title Tropical wind spd at 50 mb ('utit') )';endif
if(flds=22);'draw title Tropical wind vtr at 50 mb ('utit') )';endif
...
if(field=1);fnam="nh100zac_die";endif
if(field=2);fnam="sh100zac_die";endif
if(field=3);fnam="nh50zac_die";endif
if(field=4);fnam="sh50zac_die";endif
if(field=5);fnam="tr100uac_die";endif
if(field=6);fnam="tr100vac_die";endif
if(field=7);fnam="tr100sac_die";endif
if(field=8);fnam="tr50uac_die";endif
if(field=9);fnam="tr50vac_die";endif
if(field=10);fnam="tr50sac_die";endif
if(field=11);fnam="nh100zrms_die";endif
if(field=12);fnam="sh100zrms_die";endif
if(field=13);fnam="nh50zrms_die";endif
if(field=14);fnam="sh50zrms_die";endif
if(field=15);fnam="tr100urms_die";endif
if(field=16);fnam="tr100vrms_die";endif
if(field=17);fnam="tr100srms_die";endif
if(field=18);fnam="tr100rrms_die";endif
if(field=19);fnam="tr50urms_die";endif
if(field=20);fnam="tr50vrms_die";endif
if(field=21);fnam="tr50srms_die";endif
if(field=22);fnam="tr50rrms_die";endif
return fnam
