...
case $ICNT in
  ...
  2) EXPID2=$EXPID;SDIR=${SDIR_2};GEXPID2=PRY;;
  3) EXPID3=$EXPID;SDIR=${SDIR_3};GEXPID3=PRYLO;;
...
RZDMDIR=/home/people/emc/www/htdocs/gmb/yzhu/exp/GFS_EXP_2007/$IDS
