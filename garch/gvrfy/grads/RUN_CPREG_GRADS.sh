...
#set -x
GDIR=$GTMP/$LOGNAME/grads_ECM_GFS  
mkdir -p $GDIR
...
case $ICNT in
  ...
  3) EXPID3=$EXPID;SDIR=${SDIR_3};GEXPID3=E-G;;
  4) EXPID4=$EXPID;SDIR=${SDIR_4};GEXPID4=G-E;;
esac
...
RZDMDIR=/home/people/emc/www/htdocs/gmb/yluo/ECM_GFS   
