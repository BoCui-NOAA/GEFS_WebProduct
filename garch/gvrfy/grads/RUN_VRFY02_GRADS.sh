...
#set -x
GDIR=$GTMP/Yan.Luo/grads_VRFY02   
mkdir -p $GDIR
...
case $ICNT in
  1) EXPID1=$EXPID;SDIR=${SDIR_1};GEXPID1=00Z;GEXPID=00Z;VHOUR=00;;
  2) EXPID2=$EXPID;SDIR=${SDIR_2};GEXPID2=06Z;GEXPID=06Z;VHOUR=06;;
  3) EXPID3=$EXPID;SDIR=${SDIR_3};GEXPID3=12Z;GEXPID=12Z;VHOUR=12;;
  4) EXPID4=$EXPID;SDIR=${SDIR_4};GEXPID4=18Z;GEXPID=18Z;VHOUR=18;;
  5) EXPID5=$EXPID;SDIR=${SDIR_5};GEXPID5=12E;GEXPID=12E;VHOUR=12;;
  6) EXPID6=$EXPID;SDIR=${SDIR_6};GEXPID6=00E;GEXPID=00E;VHOUR=00;;
esac
...
$SHOME/Yan.Luo/gvrfy/grads/readin2grads.sh $STYMD $EDYMD $EXPID $FDAYS $SDIR $GDIR $GEXPID

sed -e "s/EXPID/$GEXPID/" \
    -e "s/CYMDH/$CYMDH/" \
    $SHOME/Yan.Luo/gvrfy/grads/run_4_grads.ctl > pr$GEXPID.ctl    
...
RZDMDIR=/home/people/emc/www/htdocs/gmb/yluo/GFS_VRFY02
