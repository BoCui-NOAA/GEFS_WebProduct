...
*if (frms=1)
*if (flds<=10)
*'run /nfsuser/g01/wx22lu/grads/linesmpos.gs leg_lines 1.2 4.5 2.5 6.0'
*else
*'run /nfsuser/g01/wx22lu/grads/linesmpos.gs leg_lines 1.2 6.3 2.5 7.7'
*endif
*endif
...
if (flds<=10)
'run linesmpos.gs leg_lines 1.2 4.5 2.5 6.0'
else
'run linesmpos.gs leg_lines 1.2 6.3 2.5 7.7'
endif
...
'print'
'disable print'
'printim  'fnam'.png png x1100 y850 white'
