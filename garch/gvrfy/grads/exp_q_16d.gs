...
'set strsiz 0.16'
'set string 1 tl 4'
'draw string 0.2 7.6 cdas='qday0
'set string 2 tl 4'
...
'set string 5 tl 4'
'draw string 0.2 6.0 4day='qday4   
'set string 6 tl 4'
'draw string 0.2 5.6 5day='qday5   
'set string 7 tl 4'
'draw string 0.2 5.2 6day='qday6   
'set string 8 tl 4'
'draw string 0.2 4.8 7day='qday7   
...
'set strsiz 0.16'
'set string 1 tl 4'
'draw string 0.2 3.8 cdas='qday0
'set string 2 tl 4'
...
'set string 5 tl 4'
'draw string 0.2 2.2 4day='qday4   
'set string 6 tl 4'
'draw string 0.2 1.8 5day='qday5   
'set string 7 tl 4'
'draw string 0.2 1.4 6day='qday6   
'set string 8 tl 4'
'draw string 0.2 1.0 7day='qday7   
...
word=subwrd(line,4)
'set x 5'
'define tx5=ave('var1',time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
'set x 6'
'define tx6=ave('var1',time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
word=subwrd(line,4)
'set x 5'
'define ty5=ave('var1',time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
'set x 6'
'define ty6=ave('var1',time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'set string 5 tl 4'
'draw string 5.0 4.6 4-day'   
'set string 6 tl 4'
'draw string 5.0 4.2 5-day'  
