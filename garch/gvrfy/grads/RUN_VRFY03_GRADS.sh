...
if [ $# -lt 3 ]; then
   ...
   cat /gpfs/dell2/emc/verification/save/Yan.Luo/scripts/grads_table
   exit
fi
...
uname=Yan.Luo
SHOME=/gpfs/dell2/emc/verification/save
stmp=/gpfs/dell2/stmp
home=/gpfs/dell2/emc/verification/save/Yan.Luo
...
case $ICNT in
  1) EXPID1=$EXPID;SDIR=${SDIR_1};GEXPID1=GFS;VHOUR=00;;
  2) EXPID2=$EXPID;SDIR=${SDIR_2};GEXPID2=ecm;VHOUR=12;;
  3) EXPID3=$EXPID;SDIR=${SDIR_3};GEXPID3=CTL;VHOUR=00;;
  4) EXPID4=$EXPID;SDIR=${SDIR_4};GEXPID4=ctl;VHOUR=12;;
  5) EXPID5=$EXPID;SDIR=${SDIR_5};GEXPID5=GFS;VHOUR=00;;
  6) EXPID6=$EXPID;SDIR=${SDIR_6};GEXPID6=GFS;VHOUR=00;;
esac

SYMDH=$STYMD$VHOUR

FDAYS=`$home/bin/LCHECK.sh $SDIR/SCORES${EXPID}.$SYMDH `
...
sed -e "s/ICNT/$ICNT/" \
    ...
    -e "s/PR5/$GEXPID5/" \
    -e "s/PR6/$GEXPID6/" \
    /gpfs/dell2/emc/verification/save/Yan.Luo/vrfy_grads/pub/leg_${ICNT}lines >leg_lines
...
RZDMDIR=/home/people/emc/www/htdocs/gmb/yluo/GFS_VRFY03
...
ftpemcrzdm emcrzdm put $RZDMDIR $GDIR $fname\_ac_rms.png
done
...
ftpemcrzdm emcrzdm put $RZDMDIR $GDIR $fname\_die.png
done
...
ftpemcrzdm emcrzdm put $RZDMDIR $GDIR $fname\_ac.png
#gxgif -r -x 1100 -y 850 -i $fname\_rms.gr -o $fname\_rms.gif
ftpemcrzdm emcrzdm put $RZDMDIR $GDIR $fname\_rms.png
done

for fname in tr850u_1days tr850v_1days \
             tr850u_2days tr850v_2days \
             tr850u_3days tr850v_3days \
             tr850s_1days tr850r_1days \
             tr850s_2days tr850r_2days \
