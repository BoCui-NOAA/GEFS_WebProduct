      program TEST
      dimension f(144,73)
      character*80 apgb,apgi
      apgb='/global/prs/pgbf24.2000011000'
      apgi='/global/prs/pgbf24i.2000011000'
      idate=2000011000
      print *, idate
      call getanl(f,apgb,apgi,7,500,idate,24)
      write (*,999) (f(i,25),i=1,10)
      idate=1999031700
      call getanl(f,apgb,apgi,7,500,idate,24)
      write (*,999) (f(i,25),i=1,10)
      idate=199031700
...
c--------+----------+----------+----------+----------+----------+----------+--
     ...
     .           kf,k,kpds,kgds,lb,data,iret)
      if(iret.eq.0) then
        ...
        print *, (data(i),i=1000,1010)
c       print *, (lb(i),i=1000,1010)
        print *, lb
        do i = 1, 144
         do j = 1, 73
          ij=(j-1)*144 + i
