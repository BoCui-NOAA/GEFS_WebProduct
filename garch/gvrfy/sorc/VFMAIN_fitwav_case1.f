...
c
       ...
       tfanl = fanl
       tclim = clim
       call fitwav_1d(tfcst,144,73,1,3)
       call fitwav_1d(tfanl,144,73,1,3)
       call fitwav_1d(tclim,144,73,1,3)
       zfcst=0.0
       zfanl=0.0
       zclim=0.0
       do lon = 1, 144
...
c
       ...
       tfanl = fanl
       tclim = clim
       call fitwav_1d(tfcst,144,73,4,9)
       call fitwav_1d(tfanl,144,73,4,9)
       call fitwav_1d(tclim,144,73,4,9)
       zfcst=0.0
       zfanl=0.0
       zclim=0.0
       do lon = 1, 144
...
c
       ...
       tfanl = fanl
       tclim = clim
       call fitwav_1d(tfcst,144,73,10,20)
       call fitwav_1d(tfanl,144,73,10,20)
       call fitwav_1d(tclim,144,73,10,20)
       zfcst=0.0
       zfanl=0.0
       zclim=0.0
       do lon = 1, 144
...
c
       ...
       tfanl = fanl
       tclim = clim
       call fitwav_1d(tfcst,144,73,1,20)
       call fitwav_1d(tfanl,144,73,1,20)
       call fitwav_1d(tclim,144,73,1,20)
       zfcst=0.0
       zfanl=0.0
       zclim=0.0
       do lon = 1, 144
