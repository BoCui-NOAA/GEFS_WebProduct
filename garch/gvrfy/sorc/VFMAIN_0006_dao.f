       ...
       if (ifh.eq.0) then
        if (ndatef.ge.2001112000) then
         ...
         if (ifd.eq.7) then
          jffd=7
          jafd=7
         elseif (ifd.eq.33) then
          jffd=11
          jafd=11
         elseif (ifd.eq.34) then
          jffd=12
          jafd=12
         else
          jffdu=11
...
c
       ...
       if (ifd.gt.100) then
        call getanl(ufst,cf1,cf2,jffdu,ilv,ndatef,ifh)
        call getanl(vfst,cf1,cf2,jffdv,ilv,ndatef,ifh)
        if(ufst(1,1).eq.-9999.99) goto 998
        if(vfst(1,1).eq.-9999.99) goto 998
        call fitr30(ufst)
        call fitr30(vfst)
       else
        call getanl(fcst,cf1,cf2,jffd,ilv,ndatef,ifh)
...
c
       ...
       if (ifd.gt.100) then
        call getanl(uanl,ca1,ca2,jafdu,ilv,ndatea,0)
        call getanl(vanl,ca1,ca2,jafdv,ilv,ndatea,0)
        if(uanl(1,1).eq.-9999.99) goto 998
        if(vanl(1,1).eq.-9999.99) goto 998
        call fitr30(uanl)
        call fitr30(vanl)
       else
        call getanl(fanl,ca1,ca2,jafd,ilv,ndatea,0)
