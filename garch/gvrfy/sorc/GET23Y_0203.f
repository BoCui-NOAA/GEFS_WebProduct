...
c--------+----------+----------+----------+----------+----------+----------+--
      ...
      dimension jlev(17)                 
      character*2  cim(12)
      character*90 cpgb,cpgi    
      logical*1   lb(mdata)
c     adding more levels for climatology
c      (11/18/2002 -Yuejian Zhu)
c     data      jlev/1000, 850, 700, 500, 400, 300, 
c    .                250, 200, 150, 100,  75,  50/
      data      jlev/1000, 925, 850, 700, 600, 500, 400, 300, 
     .                250, 200, 150, 100,  70,  50,  30,  20,  10/
      data      cim /'01','02','03','04','05','06',
     .               '07','08','09','10','11','12'/
      data      cpgb/'/ensemble/noscrub/emc.enspara/cdas/pgb.f00'/
      data      cpgi/'/ensemble/noscrub/emc.enspara/cdas/pgb.f00'/
c
      glb=-9999.99
      ...
      goto 993
  100 continue
c     cpgb(21:22)=cim(imon)
c     cpgi(21:22)=cim(imon)
      cpgb(33:34)=cim(imon)
      cpgi(33:34)=cim(imon)
      itime=ihr+ifr
      if (mod(itime,24).eq.0) then
c        cpgb(23:26)='.00Z'
c        cpgi(23:32)='.00Z.index'
         cpgb(35:38)='.00Z'
         cpgi(35:44)='.00Z.index'
      else if (mod(itime,24).eq.12) then
c        cpgb(23:26)='.12Z'
c        cpgi(23:32)='.12Z.index'
         cpgb(35:38)='.12Z'
         cpgi(35:44)='.12Z.index'
c adding two more optional, Y. Zhu ( 06/06/2001 )
      else if (mod(itime,24).eq.06) then
c        cpgb(23:26)='.06Z'
c        cpgi(23:32)='.06Z.index'
         cpgb(35:38)='.06Z'
         cpgi(35:44)='.06Z.index'
      else if (mod(itime,24).eq.18) then
c        cpgb(23:26)='.18Z'
c        cpgi(23:32)='.18Z.index'
         cpgb(35:38)='.18Z'
         cpgi(35:44)='.18Z.index'
      else
         goto 994
      endif
c     print *, cpgb(1:26)   
c     print *, cpgi(1:32)   
c     call baopenr(11,cpgb(1:26),iretb)
c     call baopenr(21,cpgi(1:32),ireti)
      print *, cpgb(1:38)   
      print *, cpgi(1:44)   
      call baopenr(11,cpgb(1:45),iretb)
      call baopenr(21,cpgi(1:51),ireti)
      print *, '=== Read 23 years CDAS/Reanl Climatology data ==='
      print *, ' Month =',imon,' fld =',ifd,' level =',ilev,
     .         ' itime =',itime    
      j       = -1
      jpds    = -1
      jgds    = -1
