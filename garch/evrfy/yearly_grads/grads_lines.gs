...
'set ccolor 3'
'd 'var3''
'draw title Seasonal Ave. Scores (NH 500hPa Height, 5-d forecasts)'
'draw ylab AC scores'
...
'set strsiz 0.12'
'set string 1 tl 6'
'draw string 2.5 1.4 MRF='pranh500
'set string 2 tl 6'
...
'set ccolor 3'
'd 'var3''
'draw title Seasonal Ave. Scores (SH 500hPa Height, 5-d forecasts)'
'draw ylab AC scores'
