...
line=sublin(result,1)
word=subwrd(line,4)
'define td=ave('var4',time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_3lines 1.2 4.5 2.5 5.5'
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_4lines 4.0 0.5 5.3 1.5'
'set vpage 0.0 11.0 0.8 8.5'
'draw title AVERAGE FOR JUN 2000 -- FEB 2004'
