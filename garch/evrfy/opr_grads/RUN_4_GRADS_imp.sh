...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $home/evrfy/opr_grads/grads_die_15d_rmse_imp.gs >map.gs        
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $home/evrfy/opr_grads/grads_die_15d_variance_imp.gs >map.gs        
...
gxgif -r -x 1100 -y 850 -i nh500h_rms_die.gr -o nh500h_rms_die_imp.gif
#ftpemcrzdm emcrzdm put $RZDMDIR /$ptmp/Yan.Luo/opr_grads  nh500h_rms_die.gif

gxgif -r -x 1100 -y 850 -i sh500h_rms_die.gr -o sh500h_rms_die_imp.gif
#ftpemcrzdm emcrzdm put $RZDMDIR /$ptmp/Yan.Luo/opr_grads  sh500h_rms_die.gif

gxgif -r -x 1100 -y 850 -i nh500h_variance_die.gr -o nh500h_variance_die_imp.gif
gxgif -r -x 1100 -y 850 -i sh500h_variance_die.gr -o sh500h_variance_die_imp.gif


fig2web.sh  nh500h_rms_die_imp.gif evrfy_fal2015
fig2web.sh  sh500h_rms_die_imp.gif evrfy_fal2015
fig2web.sh  nh500h_variance_die_imp.gif  evrfy_fal2015
fig2web.sh  sh500h_variance_die_imp.gif  evrfy_fal2015
