      ...
      dimension pcor(3,14,icyc,idayss),prms(3,14,icyc,idayss)
     ...
     &          '14pac','14rms'/
      data flab/'T10  ','T+1  ','T14  ','T+1  ','T15  ','T+1  ','T16  ',
     &          'T+1  ','R10  ','R14  ','R15  ','R16  ','Rs5  ','Sg4  '/
...
c       endif
     ...
     *                      (rms(i,j,k,jj,ii),j=1,4)
          enddo
          read (iunit,221) (pcor(i,j,jj,ii),j=1,14)
          read (iunit,222) (prms(i,j,jj,ii),j=1,14)
         enddo
         ...
         do i = 1, 3
          ...
          read (iunit,212)  (fit(i,j,5,jj,ii),j=13,16)
          read (iunit,212)  (fit(i,j,6,jj,ii),j=1,12)
          read (iunit,212)  (fit(i,j,6,jj,ii),j=13,16)

          read (iunit,212)  (fit(i,j,7,jj,ii),j=1,12)
          read (iunit,212)  (fit(i,j,7,jj,ii),j=13,17)
          read (iunit,212)  (fit(i,j,8,jj,ii),j=1,12)
          read (iunit,212)  (fit(i,j,8,jj,ii),j=13,17)
          ...
          read (iunit,212)  (fit(i,j,11,jj,ii),j=13,15)
          read (iunit,212)  (fit(i,j,12,jj,ii),j=1,12)
          read (iunit,212)  (fit(i,j,12,jj,ii),j=13,16)
 ...
 215  format(80x)                              
 221  format(5x,1x,14(f5.3))
 222  format(5x,1x,14(f5.1))
c 
         upamt=950.00              
         do i = 1, 3    
          do j = 1, 4  
...
CCC
     ...
     *                        pcor(i,13,jj,ii),pcor(i,14,jj,ii))
         ...
         enddo
         pcormrf(i,jj,ii)=float(icnt)/14.0
         print *, "pcormrf = ", i,jj,ii,pcormrf(i,jj,ii)
         icnt=0
         do j = 1, 14
       ...
       enddo
       do k = 1, ig
        write (52) ((rms(i,4,k,jj,ii),jj=1,icyc,2),i=1,ih)
       enddo
       do j = 1, 14
        write (52) ((prms(i,j,jj,ii),jj=1,icyc,2),i=1,ih)
       enddo
       do i = 1, ih    
        do j = 1, 4
         do jj = 1, icyc
        ...
        enddo
c      ensemble spread
        write (51) ((fit(i,j,14,jj,ii),jj=1,icyc,2),j=1,4)
        write(*,'(4f7.1)') ((fit(i,j,12,jj,ii),jj=11,11),j=1,4)
       enddo
       do i = 1, ih    
        write (51) ((fit(i,j,1,jj,ii),jj=1,icyc,2),j=1,2),
     *             ((fit(i,j,1,jj,ii),jj=1,icyc,2),j=10,11)
        write(*,'(4f7.1)') ((fit(i,j,1,jj,ii),jj=11,11),j=1,2),
     *             ((fit(i,j,1,jj,ii),jj=11,11),j=10,11)
       enddo
       do i = 1, ih    
        write (51) ((fit(i,j,2,jj,ii),jj=1,icyc,2),j=1,2),
     *             ((fit(i,j,2,jj,ii),jj=1,icyc,2),j=10,11)
        write(*,'(4f7.1)') ((fit(i,j,2,jj,ii),jj=11,11),j=1,2),
     *             ((fit(i,j,2,jj,ii),jj=11,11),j=10,11)
       enddo
       do i = 1, ih    
        write (51) ((fit(i,j,3,jj,ii),jj=1,icyc,2),j=1,2),
     *             ((fit(i,j,3,jj,ii),jj=1,icyc,2),j=14,15)
        write(*,'(4f7.1)') ((fit(i,j,3,jj,ii),jj=11,11),j=1,2),
     *             ((fit(i,j,3,jj,ii),jj=11,11),j=14,15)
       enddo
       do i = 1, ih    
        write (51) ((fit(i,j,4,jj,ii),jj=1,icyc,2),j=1,2),
     *             ((fit(i,j,4,jj,ii),jj=1,icyc,2),j=14,15)
        write(*,'(4f7.1)') ((fit(i,j,4,jj,ii),jj=11,11),j=1,2),
     *             ((fit(i,j,4,jj,ii),jj=11,11),j=14,15)
       enddo
       do i = 1, ih    
        write (51) ((fit(i,j,5,jj,ii),jj=1,icyc,2),j=1,2),
     *             ((fit(i,j,5,jj,ii),jj=1,icyc,2),j=15,16)
        write(*,'(4f7.1)') ((fit(i,j,5,jj,ii),jj=11,11),j=1,2),
     *             ((fit(i,j,5,jj,ii),jj=11,11),j=15,16)
       enddo
       do i = 1, ih    
        write (51) ((fit(i,j,6,jj,ii),jj=1,icyc,2),j=1,2),
     *             ((fit(i,j,6,jj,ii),jj=1,icyc,2),j=15,16)
        write(*,'(4f7.1)') ((fit(i,j,6,jj,ii),jj=11,11),j=1,2),
     *             ((fit(i,j,6,jj,ii),jj=11,11),j=15,16)
       enddo
      enddo
