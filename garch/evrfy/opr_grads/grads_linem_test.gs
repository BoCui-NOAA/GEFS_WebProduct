...
grfile='nh500h_'istday'days_ac.gr'
say grfile
'enable print 'grfile
'reset'
...
word=subwrd(line,4)
ens500=digs(word,3)
'define tcnt=ave('var14',time='ts',time='te')'
'd tcnt'
say result
line=sublin(result,1)
word=subwrd(line,4)
max500=digs(word,3)
'define tcnt=ave('var15',time='ts',time='te')'
'd tcnt'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'draw title NH 500 mb Geopotential Height 'istday' days forecast \ for 'ts' - 'te' '
'draw ylab AC scores'

*'set vpage 0 11 0 8.5'
'set strsiz 0.14'
'set string 1 tl 6'
'draw string 9.0 1.8 GFS='mrf500
'set string 2 tl 6'
'draw string 9.0 1.6 CTL='ctl500
'set string 3 tl 6'
'draw string 9.0 1.4 ENS='ens500
'set string 4 tl 6'
'draw string 9.0 1.2 MAX='max500
'set string 4 tl 6'
'draw string 9.0 1.0 MIN='min500

bmax=10.0
'set vpage 0 11 0 3'
'set grads off'
'set barbase 5.0|bottom|top'
*'set baropts outline'
'set baropts filled'
'set bargap 40'
...
if(iday=11);ymin=-0.4;endif;
if(iday=12);ymin=-0.5;endif;
if(iday=13);ymin=-0.6;endif;
if(iday=14);ymin=-0.6;endif;
if(iday=15);ymin=-0.6;endif;
return ymin
