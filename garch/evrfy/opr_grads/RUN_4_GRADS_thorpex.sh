...
$HOME/evrfy/opr_grads/readin2grads_test.sh $STYMD $EDYMD $EXPID $FDAYS $SDIR $GDIR $ICNT
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/opr_grads/grads_die_15d_test.gs >map.gs
...
#ftprzdm rzdm put $RZDMDIR /ptmp/wx20yz/opr_grads  nh500h_ac_die_$YYYY.gif
