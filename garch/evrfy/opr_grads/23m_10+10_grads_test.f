...
c         read (iunit,212)  (fit(i,j,5,jjj,ii),j=1,11)
c         read (iunit,212)  (fit(i,j,6,jjj,ii),j=1,11)
...
CCC
      ...
      do ii = 1, idays
       ...
       do jj=1,icyc
        do i=1, ih
         if (pcor(i,1,jj,ii).ne.-999.99) then
