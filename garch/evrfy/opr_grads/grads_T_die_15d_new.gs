...
grfile='/ptmpp1/Yan.Luo/opr_grads/'greg'500h_tg_die.gr'
say grfile
'enable print 'grfile
'reset'
...
word=subwrd(line,4)
'set y 4'       
'define tb=ave('var1',time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'set y 1'       
'define te=ave('var3',time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
'set y 4'       
...
'run linesmpos.gs leg_T3lines 8.6 1.0 10.1 2.2'

'print'
'disable print'
'printim  'greg'500h_tg_die.png png x1100 y850 white'
...
'set display color white'
'clear'
grfile='/ptmpp1/Yan.Luo/opr_grads/'greg'500h_tg-1_die.gr'
say grfile
'enable print 'grfile
'reset'
'set vpage 0.0 11.0 0.0 8.0'                    
...
'print'
'disable print'
'printim  'greg'500h_tg-1_die.png png x1100 y850 white'
