...
export STYMD=$STYMD
export EDYMD=$EDYMD
SDIR_1=/lfs/h2/emc/vpppg/noscrub/yan.luo/evrfy                 
...
CMM=`grep $MM /ensemble/yan.luo/bin/mon2mon | cut -c8-10`
CYMDH=00Z$DD$CMM$YY
...
gxgif -r -x 1100 -y 850 -i nh500h_$dd\days_tg.gr -o nh500h_$dd\days_tg.gif
ftpemcrzdm emcrzdm put $RZDMDIR /$ptmp/yan.luo/opr_grads  nh500h_$dd\days_tg.gif

gxgif -r -x 1100 -y 850 -i sh500h_$dd\days_tg.gr -o sh500h_$dd\days_tg.gif
ftpemcrzdm emcrzdm put $RZDMDIR /$ptmp/yan.luo/opr_grads  sh500h_$dd\days_tg.gif
