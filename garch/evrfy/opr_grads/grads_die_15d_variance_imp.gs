...
'run linesmpos.gs leg_3lines 2.3 1.2 3.8 2.2'
...
'set display color white'
'clear'
grfile=''greg'500h_variance_die.gr'
say grfile
'enable print 'grfile
'reset'
...
'set y 2'
'define te=ave('var4',time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'draw string 9.76 0.55 14'
'draw string 10.32 0.55 15'
*'run linesmpos.gs leg_5lines 8.6 1.0 10.1 2.2'
'set vpage 0.0 11.0 0.0 8.5'
'draw title Percentage Improvement of Error Variance from CTL to ENS \ for 'titreg' 500 mb Height\Average For 'ts' - 'te''
