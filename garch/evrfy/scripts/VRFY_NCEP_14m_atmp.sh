...
tmpdir=$GTMP/$LOGNAME/evrfy_14m_atmp
...
while [ $kcnt -le $nstep ]; do
   ...
   cat $GLOBAL/ENS/t$ilv.$ymdhp00 $GLOBAL/ENS/t$ilv.$ymdhm12 > $pgb
   $windex $pgb $pgi
   ...
   cat $GLOBAL/ENS/t$ilv.$ymdhp24 $GLOBAL/ENS/t$ilv.$ymdhp12 >$pgb
   $windex $pgb $pgi
...
cat scores.t850 scores.t2m >$NGLOBAL/$LOGNAME/evrfy/SCOTMPs.$stymd\00
