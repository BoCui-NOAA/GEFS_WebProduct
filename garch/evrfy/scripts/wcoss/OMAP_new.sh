...
do
 ...
 ftpemcrzdm emcrzdm put $RZDMDIR/$CDATE /$ptmp/Yan.Luo/omap omap_${CDATE}_$fhr.gif
done
...
ftpemcrzdm emcrzdm put $RZDMDIR/$CDATE /$ptmp/Yan.Luo/omap omap_${CDATE}_map1.gif
export CDATE=$IYMDH
gxgif -r -x 1100 -y 850 -i omap_${CDATE}_map2.gr -o omap_${CDATE}_map2.gif
ftpemcrzdm emcrzdm put $RZDMDIR/$CDATE /$ptmp/Yan.Luo/omap omap_${CDATE}_map2.gif
