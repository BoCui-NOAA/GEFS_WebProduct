...
if [ -s $GLOBAL/cmc_ens/z$ilv.$stymd\00 ]; then
   cp $GLOBAL/cmc_ens/z$ilv.$stymd\00 cmc_anl.$ilv
fi
$windex cmc_anl.$ilv cmc_anl.$ilv.index
var="cfiles(1,1)='cmc_anl.$ilv',"
echo "$var"
echo "$var" >>input2
var="cfiles(2,1)='cmc_anl.$ilv.index',"
echo "$var"
echo "$var" >>input2
...
while [ $kcnt -le $nstep ]; do
   ...
   cp $GLOBAL/cmc_ens/z$ilv.$ymdhp00 $pgb
   $windex $pgb $pgi
   ...
   cp $GLOBAL/cmc_ens/z$ilv.$ymdhp24 $pgb
   $windex $pgb $pgi
...
#/nfsuser/g01/wx20yz/evrfy/exec/vrfy_cmc_20060530  <input0
...
#/nfsuser/g01/wx20yz/evrfy/cmc_grads/RUN_4_GRADS.sh
#/nfsuser/g01/wx20yz/evrfy/ecm_grads/RUN_4_GRADS_tg.sh
