...
SDIR_1=/ensemble/noscrub/Yan.Luo/evfscores_20m               
exp_id_1=s
PFDAYS=5 
FDAYS=5 
SNAME=   
...
$home/evrfy/grads/readin2grads_20m.sh $STYMD $EDYMD $EXPID $FDAYS $SDIR $GDIR $ICNT
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $home/evrfy/monthly_grads/grads_line_a20060530_20m.gs >map.gs
fi
