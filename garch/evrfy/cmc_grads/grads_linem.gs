...
grfile='nh500h_'istday'days_ac_cmc.gr'
say grfile
'enable print 'grfile
'reset'
...
'set strsiz 0.18'
'set string 1 tl 6'
'draw string 8.8 2.2 CTL='ctl500
'set string 2 tl 6'
'draw string 8.8 1.9 10M='ens500
'set string 3 tl 6'
'draw string 8.8 1.6 16M='ens16m
'set string 4 tl 6'
'draw string 8.8 1.3 MAX='max500
'set string 4 tl 6'
'draw string 8.8 1.0 MIN='min500
