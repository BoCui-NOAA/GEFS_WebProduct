...
STYMD=$STYMD  
EDYMD=$EDYMD   
SDIR_1=/global/noscrub/wx20yz/evrfy                   
exp_id_1=m
PFDAYS=5 
FDAYS=5 
SNAME=   
...
GDIR=/ptmp/wx20yz/cmc_grads   
mkdir -p $GDIR;cd $GDIR;pwd

cp $HOME/evrfy/cmc_grads/leg_* .
...
CMM=`grep $MM /global/save/wx20yz/bin/mon2mon | cut -c8-10`
CYMDH=00Z$DD$CMM$YY
...
do
  EXPID1=$EXPID;SDIR=${SDIR_1};
$HOME/evrfy/cmc_grads/readin2grads.sh $STYMD $EDYMD $EXPID $FDAYS $SDIR $GDIR $ICNT

sed -e "s/EXPID/$EXPID/" \
    -e "s/CYMDH/$CYMDH/" \
    $HOME/evrfy/cmc_grads/run_4_grads.ctl > pr$EXPID.ctl    

sed -e "s/EXPID/$EXPID/" \
    -e "s/CYMDH/$CYMDH/" \
    $HOME/evrfy/cmc_grads/run_4_gradm.ctl > pm$EXPID.ctl    
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/cmc_grads/grads_lines.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/cmc_grads/grads_linem.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/cmc_grads/grads_die_10d.gs >map.gs        
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/cmc_grads/grads_T_die_15d.gs >map.gs        
...
gxgif -r -x 695 -y 545 -i $fname\_ac_cmc.gr -o $fname\_ac_cmc.gif
gxgif -r -x 695 -y 545 -i $fname\_rms_cmc.gr -o $fname\_rms_cmc.gif
ftprzdm rzdm put $RZDMDIR /ptmp/wx20yz/cmc_grads  $fname\_ac_cmc.gif  
ftprzdm rzdm put $RZDMDIR /ptmp/wx20yz/cmc_grads  $fname\_rms_cmc.gif  

done

gxgif -r -x 695 -y 545 -i nh500h_ac_die_cmc.gr  -o nh500h_ac_die_cmc.gif
gxgif -r -x 695 -y 545 -i nh500h_rms_die_cmc.gr -o nh500h_rms_die_cmc.gif
ftprzdm rzdm put $RZDMDIR /ptmp/wx20yz/cmc_grads  nh500h_ac_die_cmc.gif
ftprzdm rzdm put $RZDMDIR /ptmp/wx20yz/cmc_grads  nh500h_rms_die_cmc.gif

gxgif -r -x 695 -y 545 -i sh500h_ac_die_cmc.gr  -o sh500h_ac_die_cmc.gif
gxgif -r -x 695 -y 545 -i sh500h_rms_die_cmc.gr -o sh500h_rms_die_cmc.gif
ftprzdm rzdm put $RZDMDIR /ptmp/wx20yz/cmc_grads  sh500h_ac_die_cmc.gif
ftprzdm rzdm put $RZDMDIR /ptmp/wx20yz/cmc_grads  sh500h_rms_die_cmc.gif
