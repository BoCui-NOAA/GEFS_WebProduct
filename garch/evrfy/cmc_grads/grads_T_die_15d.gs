...
grfile='/ptmp/wx20yz/opr_grads/'greg'500h_tg_die.gr'
say grfile
'enable print 'grfile
'reset'
...
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_T3lines 8.6 1.0 10.1 2.2'
...
'set display color white'
'clear'
grfile='/ptmp/wx20yz/opr_grads/'greg'500h_tg-1_die.gr'
say grfile
'enable print 'grfile
'reset'
'set vpage 0.0 11.0 0.0 8.0'                    
