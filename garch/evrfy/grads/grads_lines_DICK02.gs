...
'define tcnt=ave('var3'.4,time='ts',time='te')'
'd tcnt'
say result
line=sublin(result,1)
word=subwrd(line,4)
prznh500=digs(word,3)
...
'set strsiz 0.12'
'set string 1 tl 6'
'draw string 9.0 1.7 ENd='prsnh500
'set string 2 tl 6'
'draw string 9.0 1.5 ENe='prxnh500
'set string 3 tl 6'
'draw string 9.0 1.3 ENi='prynh500
'set string 4 tl 6'
'draw string 9.0 1.1 ENj='prznh500
...
*line=sublin(result,1)
*word=subwrd(line,4)
*prfnh500=digs(word,3)
*
*'define tcnt=ave('var5'.3,time='ts',time='te')'
*'d tcnt'
*say result
*line=sublin(result,1)
*word=subwrd(line,4)
*prgnh500=digs(word,3)
*
*'define tcnt=ave('var5'.4,time='ts',time='te')'
*'d tcnt'
*say result
*line=sublin(result,1)
*word=subwrd(line,4)
*prhnh500=digs(word,3)
...
'set strsiz 0.12'
'set string 1 tl 6'
'draw string 9.0 1.9 ENd='pranh500
'set string 2 tl 6'
'draw string 9.0 1.7 ENe='prbnh500
'set string 3 tl 6'
'draw string 9.0 1.5 ENi='prcnh500
'set string 4 tl 6'
'draw string 9.0 1.3 ENj='prdnh500
