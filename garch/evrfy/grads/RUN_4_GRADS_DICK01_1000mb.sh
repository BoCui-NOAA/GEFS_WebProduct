...
$HOME/evrfy/grads/readin2grads_1000mb.sh $STYMD $EDYMD $EXPID $FDAYS $SDIR $GDIR  1
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/grads/grads_lines_DICK01_1000mb.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/grads/grads_die_15d_DICK01_1000mb.gs >map.gs        
...
for fname in nh1000h_1days  sh1000h_1days \
             nh1000h_2days  sh1000h_2days \
             nh1000h_3days  sh1000h_3days \
             nh1000h_4days  sh1000h_4days \
             nh1000h_5days  sh1000h_5days \
             nh1000h_6days  sh1000h_6days \
             nh1000h_7days  sh1000h_7days \
             nh1000h_8days  sh1000h_8days \
             nh1000h_9days  sh1000h_9days \
             nh1000h_10days sh1000h_10days   
...
gxgif -r -x 695 -y 545 -i nh1000h_ac_die.gr  -o nh1000h_ac_die_$gname.gif
gxps  -c               -i nh1000h_ac_die.gr  -o nh1000h_ac_die_$gname.ps 
gxgif -r -x 695 -y 545 -i nh1000h_rms_die.gr -o nh1000h_rms_die_$gname.gif
gxps  -c               -i nh1000h_rms_die.gr -o nh1000h_rms_die_$gname.ps  

gxgif -r -x 695 -y 545 -i sh1000h_ac_die.gr  -o sh1000h_ac_die_$gname.gif
gxps  -c               -i sh1000h_ac_die.gr  -o sh1000h_ac_die_$gname.ps 
gxgif -r -x 695 -y 545 -i sh1000h_rms_die.gr -o sh1000h_rms_die_$gname.gif
gxps  -c               -i sh1000h_rms_die.gr -o sh1000h_rms_die_$gname.ps  
