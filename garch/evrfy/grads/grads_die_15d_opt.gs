...
'clear'
grfile='/ptmp/wx20yz/grads/nh500h_ac_die.gr'
say grfile
'enable print 'grfile
'reset'
...
word=subwrd(line,4)
'define tb=ave(ac14,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_3lines_opt 2.3 1.2 3.8 2.2'
...
line=sublin(result,1)
word=subwrd(line,4)
'define tb=ave(rm14,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
'define tc=ave(rm10,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
'define td=ave(sp1,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'draw string 9.76 0.55 14'
'draw string 10.32 0.55 15'
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_4lines_opt 8.6 1.0 10.1 2.2'
