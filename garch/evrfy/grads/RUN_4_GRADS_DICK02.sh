...
SDIR_2=/nfsuser/g01/wx20dh/evrfy/SCORES/s
SDIR_2=/nfsuser/g01/wx20dh/evrfy/SCORES/r
SDIR_4=/global/evfscores               
exp_id_1=s
exp_id_2=s
exp_id_3=r
exp_id_4= 
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/grads/grads_lines_DICK02.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/grads/grads_die_15d_DICK02.gs >map.gs        
...
gxgif -r -x 695 -y 545 -i nh500h_tg-1_die.gr -o nh500h_tg-1_die_$gname.gif
gxgif -r -x 695 -y 545 -i nh500h_tg_die.gr   -o nh500h_tg_die_$gname.gif
...
gxgif -r -x 695 -y 545 -i sh500h_tg-1_die.gr -o sh500h_tg-1_die_$gname.gif
gxgif -r -x 695 -y 545 -i sh500h_tg_die.gr   -o sh500h_tg_die_$gname.gif
