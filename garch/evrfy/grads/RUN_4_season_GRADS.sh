...
gxgif -r -x 695 -y 545 -i nh500h_ac_die.gr -o nh500h_ac_die_$SEASON$YEAR.gif
gxgif -r -x 695 -y 545 -i nh500h_rms_die.gr -o nh500h_rms_die_$SEASON$YEAR.gif
ftpsgi sgi100 put $SGIDIR /ptmp/wx20yz/grads  nh500h_ac_die_$SEASON$YEAR.gif
ftpsgi sgi100 put $SGIDIR /ptmp/wx20yz/grads  nh500h_rms_die_$SEASON$YEAR.gif

gxgif -r -x 695 -y 545 -i sh500h_ac_die.gr -o sh500h_ac_die_$SEASON$YEAR.gif
gxgif -r -x 695 -y 545 -i sh500h_rms_die.gr -o sh500h_rms_die_$SEASON$YEAR.gif
ftpsgi sgi100 put $SGIDIR /ptmp/wx20yz/grads  sh500h_ac_die_$SEASON$YEAR.gif
ftpsgi sgi100 put $SGIDIR /ptmp/wx20yz/grads  sh500h_rms_die_$SEASON$YEAR.gif

gxgif -r -x 695 -y 545 -i nh500h_tg-1_die.gr -o nh500h_tg-1_die_$SEASON$YEAR.gif
gxgif -r -x 695 -y 545 -i nh500h_tg_die.gr   -o nh500h_tg_die_$SEASON$YEAR.gif
ftpsgi sgi100 put $SGIDIR /ptmp/wx20yz/grads  nh500h_tg-1_die_$SEASON$YEAR.gif 
ftpsgi sgi100 put $SGIDIR /ptmp/wx20yz/grads  nh500h_tg_die_$SEASON$YEAR.gif 

gxgif -r -x 695 -y 545 -i sh500h_tg-1_die.gr -o sh500h_tg-1_die_$SEASON$YEAR.gif
gxgif -r -x 695 -y 545 -i sh500h_tg_die.gr   -o sh500h_tg_die_$SEASON$YEAR.gif
ftpsgi sgi100 put $SGIDIR /ptmp/wx20yz/grads  sh500h_tg-1_die_$SEASON$YEAR.gif 
ftpsgi sgi100 put $SGIDIR /ptmp/wx20yz/grads  sh500h_tg_die_$SEASON$YEAR.gif 
...
YEAR=2001
for MM in 15 12 11 10 09 14 08 07 06 13 05 04 03 16 02 01
do
 CMON=`cat $HOME/evrfy/grads/mon2mon | grep "$MM" | cut -c4-6`
 SMYEAR=$YEAR$MM
 YYYY=$YEAR
...
YEAR=2001
for MM in 15 1211 10 09 14 08 07 06 13 05 04 03 16 02 01
do
 CMON=`cat $HOME/evrfy/grads/mon2mon | grep "$MM" | cut -c4-6`
 SMYEAR=$YEAR$MM
 YYYY=$YEAR
