...
$HOME/evrfy/grads/readin2grads_prx.sh $STYMD $EDYMD $EXPID $FDAYS $SDIR $GDIR 1

sed -e "s/EXPID/$EXPID/" \
    -e "s/CYMDH/$CYMDH/" \
    $HOME/evrfy/grads/run_4_grads_prx.ctl > pr$EXPID.ctl    
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/grads/grads_lines_prx.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/grads/grads_die_15d_prx.gs >map.gs        
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/grads/grads_T_die_15d_prx.gs >map.gs        
...
gxgif -r -x 1100 -y 850 -i $fname\_ac.gr -o $fname\_ac_$gname.gif
gxps  -c               -i $fname\_ac.gr -o $fname\_ac_$gname.ps  
gxgif -r -x 1100 -y 850 -i $fname\_rms.gr -o $fname\_rms_$gname.gif
gxps  -c               -i $fname\_rms.gr -o $fname\_rms_$gname.ps  

done

gxgif -r -x 1100 -y 850 -i nh500h_ac_die.gr  -o nh500h_ac_die_$gname.gif
gxps  -c               -i nh500h_ac_die.gr  -o nh500h_ac_die_$gname.ps 
gxgif -r -x 1100 -y 850 -i nh500h_rms_die.gr -o nh500h_rms_die_$gname.gif
gxps  -c               -i nh500h_rms_die.gr -o nh500h_rms_die_$gname.ps  

gxgif -r -x 1100 -y 850 -i sh500h_ac_die.gr  -o sh500h_ac_die_$gname.gif
gxps  -c               -i sh500h_ac_die.gr  -o sh500h_ac_die_$gname.ps 
gxgif -r -x 1100 -y 850 -i sh500h_rms_die.gr -o sh500h_rms_die_$gname.gif
gxps  -c               -i sh500h_rms_die.gr -o sh500h_rms_die_$gname.ps  
