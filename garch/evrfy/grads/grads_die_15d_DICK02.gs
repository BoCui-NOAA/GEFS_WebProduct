...
line=sublin(result,1)
word=subwrd(line,4)
'define td=ave('var3'.4,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_Dick_4lines 2.3 1.2 3.8 2.2'
...
'define th=ave('var5'.4,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'draw string 9.76 0.55 14'
'draw string 10.32 0.55 15'
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_Dick_4lines 8.6 1.0 10.1 2.2'
