...
grfile='/ptmp/wx20yz/grads/'greg'1000h_ac_die.gr'
say grfile
'enable print 'grfile
'reset'
...
word=subwrd(line,4)
'define tb=ave('var3'.2,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
'define tc=ave('var3'.3,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_Dick01_3lines 2.3 1.2 3.8 2.2'
...
'set display color white'
'clear'
grfile='/ptmp/wx20yz/grads/'greg'1000h_rms_die.gr'
say grfile
'enable print 'grfile
'reset'
'set vpage 0.0 11.0 0.0 8.5'
...
'define tf=ave('var5'.2,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)

'define tg=ave('var5'.3,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'draw string 9.76 0.55 14'
'draw string 10.32 0.55 15'
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_Dick01_3lines 8.6 1.0 10.1 2.2'
