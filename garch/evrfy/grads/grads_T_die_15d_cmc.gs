...
grfile='/ptmp/wx20yz/grads/'greg'500h_tg_die.gr'
say grfile
'enable print 'grfile
'reset'
...
'set y 1'       
'define tg=ave('var2'.2,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
'set y 4'       
'define th=ave('var2'.2,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_T4lines 8.6 1.0 10.1 2.2'
...
'set display color white'
'clear'
grfile='/ptmp/wx20yz/grads/'greg'500h_tg-1_die.gr'
say grfile
'enable print 'grfile
'reset'
'set vpage 0.0 11.0 0.0 8.0'                    
