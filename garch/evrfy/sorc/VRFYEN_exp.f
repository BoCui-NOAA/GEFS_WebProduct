...
c
      ...
      dimension       spr(4),sprf(4,3),f14avg(15,3),f10avg(11,3)
     ...
     &           '17tsa',' 8ems','10ems','14ems','17tms','Meds '/
      data flab /'T08  ','T+1  ','T10  ','T+1  ','T14  ','T+1  ',
     &           'R10  ','Rs5  ','Sg4  '/
...
c ----
         ...
         call talagr(17,17,en,an,it1,ajk,xjk,pjk,jk,0)           
         call talagr(17,10,en,an,it3,ajk,xmed,prms,irel,jcon)           
c ----
...
c ----
         ...
         elseif ( lat.ge.45.and.lat.le.68 ) then
          jj = 2
          goto 2010
         elseif ( lat.ge.29.and.lat.le.45 ) then
          jj = 3
          goto 2010
         else
          goto 2020
...
c ---- 5. 2 pairs      12Z scores 
        do jj = 1, 4
         do kk = 1, 3  
          ...
          frms(kk,jj,5) = 0.0 
          do mm = 14, 17
           fcor(kk,jj,5) = fcor(kk,jj,5) + cor(kk,jj,mm)/4.0
           frms(kk,jj,5) = frms(kk,jj,5) + rms(kk,jj,mm)/4.0
          enddo
         enddo
        enddo
       if (ii.gt.1) then
...
c ----11. 17 members ( totally )
        ...
        rel5 = 0.0
        do jj = 1, 3
c        rel5(1,jj) = rel(1,jj)
c        rel5(2,jj) = rel(2,jj)
c        rel5(4,jj) = rel(13,jj)
         do kk = 1, 10
c         rel5(3,jj) = rel5(3,jj) + rel(kk+2,jj)/10.0
          rel5(3,jj) = rel5(3,jj) + rel(kk,jj)/10.0
         enddo
c        do kk = 1, 4
