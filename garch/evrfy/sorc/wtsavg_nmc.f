...
ccc
      read  (5,filec,end=1000)
 1000 continue
      write (6,filec)
      read  (5,filei,end=1010)
 1010 continue
      write (6,filei)
...
ccc 
      ...
      irms = 0
      ipcor= 0
      do ii = 1, ilen        ! totally files read
...
ccc
       ...
       enddo
      enddo
 300  format(' Anomaly Corr. For ',a5,    
     .       ' 500 mb at verify hours = ',i3)                    
