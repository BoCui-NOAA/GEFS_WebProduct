...
c
      ...
      dimension ffgrid(144,73,51),ppgrid(144,73,51)
      dimension dgrid(144,73,7),pgrid(144,73,imem)
      dimension cor(3,4,imemp4),rms(3,4,imemp4),acwt(73)
      dimension fcor(3,4,13),frms(3,4,13),irel(51),rel(imem,3)
      dimension ir10(10),r10(10,3),ir50(50)
      dimension xrms(144,73),rel5(5,3),acwta(3)
      dimension en(51),it(imemp1,4),fit(imemp1,3,4),fitavg(imemp1,3)
      dimension fit10(11,3)
      dimension jk(imem),it1(32),it2(51),ikk(2)
...
c        do im = 1, imem                 ! 11 ensemble members
         do im = 1, 51                   ! 51 ensemble members
...
c ----
         call talagr(51,50,en,an,it2,ave,xmed50,pijk,ir50,jcon)           
         call talagr(51,51,en,an,it1,ave,xmed51,prms,irel,jcon)
c ----
...
c ----
         ...
         dgrid(lon,lat,2) = xmed51       ! 51 members
         dgrid(lon,lat,4) = xmed50       ! 50 members 

c ----
c spread
c ----
         call spread(51,en,ave,spr2,2)   ! 50 members
         dgrid(lon,lat,3) = ave          ! 50 members
         call spread(51,en,ave,spr1,1)   ! 51 members
         dgrid(lon,lat,1) = ave          ! 51 members
         spr(1) = spr1
         spr(2) = spr2
c ----
