...
ccc
     ...
     &                            (arms(i,j,k,jj),j=1,4)
       ...
       do i = 1, 3
        ...
        write(kunit,312)  flab(5),(afit(i,j,5,jj),j=1,12)
        write(kunit,312)  flab(5),(afit(i,j,5,jj),j=13,21)
        write(kunit,312)  flab(6),(afit(i,j,6,jj),j=1,12)
        write(kunit,312)  flab(6),(afit(i,j,6,jj),j=13,23)
        write(kunit,312)  flab(7),(afit(i,j,7,jj),j=1,5)
        write(kunit,312)  flab(8),(afit(i,j,8,jj),j=1,4)
       enddo
