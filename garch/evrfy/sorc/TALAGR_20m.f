...
c ----
      ...
      if(m.eq.20) then         ! for 20 ensemble members
       do i=3,22
        prms=prms + (ve-en(i))*(ve-en(i))
       enddo
      endif
      if(m.eq.22) then         ! for 22 ensemble members + control + gfs
       do i=1,22
        prms=prms + (ve-en(i))*(ve-en(i))
       enddo
      endif

      if (m.eq.22.and.en(1).eq.-9999.99) goto 999
      if (m.eq.10.and.en(3).eq.-9999.99) goto 999
      if (m.eq.14.and.en(16).eq.-9999.99) goto 999
      if (m.eq.16.and.en(16).eq.-9999.99) goto 999
