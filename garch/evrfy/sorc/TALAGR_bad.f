...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c--------+----------+----------+----------+----------+----------+----------+--
      dimension en(n),em(n),enb(m,3),ena(m,3),irel(n)
      dimension it(n+1)
      irel = 0
      it   = 0
      ave  = -9999.99
...
c--------+----------+----------+----------+----------+----------+----------+--
      if (m.eq.14) then
       if (en(3).eq.-9999.99.or.en(14).eq.-9999.99) goto 999
      endif
      if (m.eq.10.and.en(3).eq.-9999.99) goto 999
      if (m.eq.8.and.en(3).eq.-9999.99) goto 999
c ----
...
c ----
       ...
       call sortmm(enb,m,3,2)
c ----
c get relative bad position for analysis
c ---- Yuejian Zhu
c ----
       iii=enb(m,3)
       irel(iii) = 2
