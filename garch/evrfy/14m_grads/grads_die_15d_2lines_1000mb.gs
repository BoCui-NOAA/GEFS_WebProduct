...
'define ta=ave('var3',time='ts',time='te')'
say result
...
'set cmark 3'
'd tc'
'draw title 'titreg'1000 mb Height ( wave 1-20 ) \ Average For 'ts' - 'te''
...
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_pac_3lines 2.3 1.2 3.8 2.2'
...
'set cmark 5'
'd ti'
'draw title 'titreg' 1000 mb Height \ Average For 'ts' - 'te''
'draw xlab Forecast days'
...
'draw string 9.76 0.55 14'
'draw string 10.32 0.55 15'
'run /nfsuser/g01/wx20yz/grads/linesmpos.gs leg_rms_2lines 8.6 1.0 10.1 2.2'
...
if(reg=1);vrmax=80;endif
if(reg=2);vrmax=80;endif
if(reg=3);vrmax=30;endif
return vrmax
function getreg(reg)
