...
'set cmark 3'
'd tc'
'draw title 'titreg' 2m TEMP. ( wave 1-20 ) \ Average For 'ts' - 'te''
...
'set cmark 5'
'd ti'
'draw title 'titreg' 2m TEMP. \ Average For 'ts' - 'te''
'draw xlab Forecast days'
...
if(reg=1);vrmax=4;endif
if(reg=2);vrmax=4;endif
if(reg=3);vrmax=2;endif
return vrmax
function getreg(reg)
