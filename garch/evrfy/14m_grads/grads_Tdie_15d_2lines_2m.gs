...
word=subwrd(line,4)
'define tc=ave('var1'.2,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
'set y 4'       
...
line=sublin(result,1)
word=subwrd(line,4)
'define td=ave('var1'.2,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'draw title Percentage Excessive Outliers of That Expected \ for 'titreg' 2 meter TEMP. Talagrand Distribution\Average For 'ts' - 'te''
'run linesmpos.gs leg_pac_2lines 8.6 1.0 10.1 2.2'
