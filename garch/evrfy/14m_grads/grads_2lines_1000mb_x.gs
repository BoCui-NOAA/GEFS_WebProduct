...
'define tcnt=ave('var2'.2,time='ts',time='te')'
'd tcnt'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'set strsiz 0.18'
'set string 1 tl 6'
'draw string 8.0 1.9 CTL_s='prsnh500
'set string 2 tl 6'
'draw string 8.0 1.5 CTL_x='prxnh500
'set string 3 tl 6'
'draw string 8.0 1.1 GFS_s='prcnh500
...
'set strsiz 0.18'
'set string 1 tl 6'
'draw string 8.0 1.9 CTL_s='pranh500
'set string 2 tl 6'
'draw string 8.0 1.5 CTL_x='prbnh500
'set string 3 tl 6'
'draw string 8.0 1.1 GFS_s='prcnh500

*'set string 1 tl 6'
*'draw string 3.0 1.6 SPR_s='prdnh500
*'set string 2 tl 6'
*'draw string 3.0 1.3 SPR_x='prenh500
*
'print'
'disable print'
