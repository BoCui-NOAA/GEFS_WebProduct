...
word=subwrd(line,4)
'define tb=ave('var2'.2,time='ts',time='te')'
say result
line=sublin(result,1)
word=subwrd(line,4)
...
'run /global/save/wx20yz/grads/linesmpos.gs leg_pacx_3lines 2.3 1.2 3.8 2.2'
...
'draw string 9.76 0.55 14'
'draw string 10.32 0.55 15'
'run /global/save/wx20yz/grads/linesmpos.gs leg_rmsx_3lines 8.6 1.0 10.1 2.2'
...
if(reg=1);vrmax=120;endif
if(reg=2);vrmax=120;endif
if(reg=3);vrmax=40;endif
return vrmax
function getreg(reg)
