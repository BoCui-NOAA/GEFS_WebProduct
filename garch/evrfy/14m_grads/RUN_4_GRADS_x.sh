...
set -x
### start to set up ###
export STYMD=20070329
export EDYMD=20070501 
SDIR_1=$NGLOBAL/wx20yz/global/exp_2006_evrfy
SDIR_2=$NGLOBAL/wx20yz/global/exp_2006_evrfy
SDIR_3=                                    
SDIR_4=                                
exp_id_1=s
exp_id_2=x
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/14m_grads/grads_2lines_1000mb_x.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/14m_grads/grads_die_15d_2lines_1000mb_x.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/14m_grads/grads_2lines_500mb_x.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $HOME/evrfy/14m_grads/grads_die_15d_2lines_500mb_x.gs >map.gs        
...
RZDMDIR=/home/people/emc/www/htdocs/gmb/yzhu/exp/L28_SIG_HYB
...
scp $fname\_ac.gif wd20yz@rzdm:$RZDMDIR

gxgif -r -x 1100 -y 850 -i $fname\_rms.gr -o $fname\_rms.gif
scp $fname\_rms.gif wd20yz@rzdm:$RZDMDIR
...
scp $fname\_die.gif wd20yz@rzdm:$RZDMDIR
