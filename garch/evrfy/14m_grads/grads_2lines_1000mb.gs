...
grfile=''greg'1000h_'istday'days_ac.gr'
say grfile
'enable print 'grfile
'reset'
...
'set strsiz 0.18'
'set string 1 tl 6'
'draw string 8.0 1.9 ENS_s='prsnh1000
'set string 2 tl 6'
'draw string 8.0 1.5 ENS_x='prxnh1000
...
grfile=''greg'1000h_'istday'days_rms.gr'
say grfile
'enable print 'grfile
'reset'
'set vpage 0 11 0 8.5'
...
'd 'var5'.2'
'set cstyle 5'
'draw title 'titreg' 1000 mb Geopotential Height at day 'istday' \ for 'ts' - 'te' '
'draw ylab RMS errors'

'set vpage 0 11 0 8.5'
'set strsiz 0.18'
'set string 1 tl 6'
'draw string 8.0 1.6 ENS_s='pranh1000
'set string 2 tl 6'
'draw string 8.0 1.3 ENS_x='prbnh1000

'set string 1 tl 6'
'draw string 3.0 1.6 SPR_s='prdnh1000
'set string 2 tl 6'
'draw string 3.0 1.3 SPR_x='prenh1000
*
'print'
'disable print'
...
if(iday=2);ymax=50.;endif;
if(iday=3);ymax=65.;endif;
if(iday=4);ymax=80.;endif;
if(iday=5);ymax=100.;endif;
...
if(iday=1);ymin=-10.;endif;
if(iday=2);ymin=-10.;endif;
if(iday=3);ymin=-10.;endif;
if(iday=4);ymin=-10.;endif;
if(iday=5);ymin=-10.;endif;
if(iday=6);ymin=-10.;endif;
if(iday=7);ymin=-10.;endif;
if(iday=8);ymin=-10.;endif;
if(iday=9);ymin=-10.;endif;
if(iday=10);ymin=-10.;endif;
if(iday=11);ymin=-10.;endif;
if(iday=12);ymin=0.0;endif;
if(iday=13);ymin=0.0;endif;
if(iday=14);ymin=0.0;endif;
if(iday=15);ymin=0.0;endif;
