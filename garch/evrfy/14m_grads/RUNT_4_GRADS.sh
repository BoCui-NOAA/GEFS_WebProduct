...
#export STYMD=20060901
export STYMD=20060901
export EDYMD=$edymd   
SDIR_1=$NGLOBAL/$LOGNAME/evrfy
SDIR_2=$NGLOBAL/$LOGNAME/evrfy
SDIR_3=                                    
SDIR_4=                                
exp_id_1=s
exp_id_2=b
...
GDIR=$PTMP/$LOGNAME/grads_14mt  
mkdir -p $GDIR;cd $GDIR;pwd

cp $HOME/evrfy/14m_grads/leg_* .
cp $SHOME/$LOGNAME/grads/linesmpos.gs .

if [ "$SNAME" = "" ]; then export SNAME=SCOTMP;fi
...
#$SHOME/$LOGNAME/evrfy/14m_grads/readin2grads.sh $STYMD $EDYMD $EXPID $FDAYS $SDIR $GDIR 1 1

sed -e "s/EXPID/$EXPID/" \
    -e "s/CYMDH/$CYMDH/" \
    $SHOME/$LOGNAME/evrfy/14m_grads/trun_4_grads.ctl > pr$EXPID.ctl
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $SHOME/$LOGNAME/evrfy/14m_grads/grads_2lines_850mb.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $SHOME/$LOGNAME/evrfy/14m_grads/grads_die_15d_2lines_850mb.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $SHOME/$LOGNAME/evrfy/14m_grads/grads_Tdie_15d_2lines_850mb.gs >map.gs
...
$SHOME/$LOGNAME/evrfy/14m_grads/readin2grads.sh $STYMD $EDYMD $EXPID $FDAYS $SDIR $GDIR 1 2
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $SHOME/$LOGNAME/evrfy/14m_grads/grads_2lines_2m.gs >map.gs
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $SHOME/$LOGNAME/evrfy/14m_grads/grads_die_15d_2lines_2m.gs >map.gs        
...
sed -e "s/EXPID1/$EXPID1/" \
    ...
    -e "s/CSTYMD/$CSTYMD/" \
    -e "s/CEDYMD/$CEDYMD/" \
    $SHOME/$LOGNAME/evrfy/14m_grads/grads_Tdie_15d_2lines_2m.gs >map.gs        
