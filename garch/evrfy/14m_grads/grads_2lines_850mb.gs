...
grfile=''greg'850t_'istday'days_ac.gr'
say grfile
'enable print 'grfile
'reset'
...
'set ccolor 2'
'd 'var4'.2'
'draw title 'titreg' 850 hPa Temperature at day 'istday' \ for 'ts' - 'te' '
'draw ylab AC scores'

'set vpage 0 11 0 8.5'
'set strsiz 0.18'
'set string 1 tl 6'
'draw string 8.0 1.9 ENS_s='prsnt850
'set string 2 tl 6'
'draw string 8.0 1.5 ENS_b='prxnt850
...
grfile=''greg'850t_'istday'days_rms.gr'
say grfile
'enable print 'grfile
'reset'
'set vpage 0 11 0 8.5'
...
'd 'var5'.2'
'set cstyle 5'
'draw title 'titreg' 850 mb Temperature at day 'istday' \ for 'ts' - 'te' '
'draw ylab RMS errors'

'set vpage 0 11 0 8.5'
'set strsiz 0.18'
'set string 1 tl 6'
'draw string 8.0 1.6 ENS_s='prant850
'set string 2 tl 6'
'draw string 8.0 1.3 ENS_b='prbnt850

'set string 1 tl 6'
'draw string 3.0 1.6 SPR_s='prdnt850
'set string 2 tl 6'
'draw string 3.0 1.3 SPR_b='prent850
*
'print'
'disable print'
...
if(iday=1);ymax=4.;endif;
if(iday=2);ymax=5.;endif;
if(iday=3);ymax=6.;endif;
if(iday=4);ymax=8.;endif;
if(iday=5);ymax=10.;endif;
if(iday=6);ymax=12.;endif;
if(iday=7);ymax=14;endif;
if(iday=8);ymax=15.;endif;
if(iday=9);ymax=16.;endif;
if(iday=10);ymax=17.;endif;
if(iday=11);ymax=17.;endif;
if(iday=12);ymax=20.;endif;
if(iday=13);ymax=0.6;endif;
if(iday=14);ymax=0.6;endif;
if(iday=15);ymax=0.6;endif;
return ymax
