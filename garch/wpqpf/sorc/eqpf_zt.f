...
ccc
C--------+---------+---------+---------+---------+---------+---------+--
      parameter(jf=10512,iem=17,ihdays=17)
...
c
      ...
      write(6,namin)
      ncnt   = 0
      gbf='/tmp/wd20yz/web/precip.dat'
      gbi='/tmp/wd20yz/web/precip.ind'
      gbo='/tmp/wd20yz/web/precip.out'
      lgbf=len_trim(gbf)
      lgbi=len_trim(gbi)
      lgbo=len_trim(gbo)
...
ccc
c      if (n.ge.3.and.mod(n-1,2).eq.0) then
       if (n.eq.iask) then
c
        izero= 0
        isame= 0
...
ccc
         ...
         ipds(16) = 3          !: or 10
         ipds(22) = 6
         call putgb(51,jf,ipds,igds,lb,f,iret)
         ipds(5)  = 60         !: OCT 9
         call putgb(51,jf,ipds,igds,lb,fm,iret)
         ipds(5)  = 61         !: OCT 9
