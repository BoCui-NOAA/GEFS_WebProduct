...
'set lat 0 80'
'set mproj nps'
'set mpvals 20 50 25 40'
'set gxout shaded'
*
'set display color white'
'clear'

'enable print gmeta_ME1'
step=4
stepend=10
while (step<=stepend)
...
'set t 'step''   
 ...
 if (step=4)
 'set vpage 0.5 5.5 3.6 7.4'
 tm1=12
 tm2=36
 endif
 if (step=6)
 'set vpage 5.5 10.5 3.6 7.4' 
 tm1=36
 tm2=60
 endif
 if (step=8)
...
endwhile
 ...
 'print'
 'disable print gmeta_ME1'
 'printim gmeta_ME1.png png x695 y545 white'
 'clear'

'enable print gmeta_ME2'
step=12
stepend=18
while (step<=stepend)
...
endwhile
 ...
 'draw title Ensemble based probability of precip. amount exceeding'
 'print'
 'disable print gmeta_ME2'
 'printim gmeta_ME2.png png x695 y545 white'
