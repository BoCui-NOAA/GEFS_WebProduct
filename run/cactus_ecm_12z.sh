...
out=$COMOUTJOB/cstar_ecmwf_12z_schedule
job1=$COMINJOB/cactus_ecm_12z.sh            
...
sub_wcoss2 -a GEFS-DEV -q $CUE -p 1/1/S -r 2048/1 -w ${NEXT_JOB_TIME} -t 3:00:00 -j cactus_ecm_12z.sh -o $out $job1
$COMINJOB/sen_opt.csh $iday $icent $lat $lon $boxsize
$COMINJOB2/show_dirlist_12z.sh
else
