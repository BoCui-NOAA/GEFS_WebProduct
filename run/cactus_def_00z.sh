...
out=$COMOUTJOB/cstar_00z_schedule_def
job1=$COMINJOB/cactus_def_00z.sh            
...
CUE=dev_transfer
sub_wcoss2 -a GEFS-DEV -q $CUE -p 1/1/S -r 1024/1 -w ${NEXT_JOB_TIME} -t 6:00:00 -j cactus_def_00z.sh -o $out $job1
