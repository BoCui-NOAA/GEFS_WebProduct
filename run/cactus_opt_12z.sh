...
out=$COMOUTJOB/senopt_12z_schedule_opt
job1=$COMINJOB/cactus_opt_12z.sh            
...
sub_wcoss2 -a GEFS-DEV -q $CUE -p 1/1/S -r 1024/1 -w ${NEXT_JOB_TIME} -t 3:00:00 -j cactus_opt_12z.sh -o $out $job1
