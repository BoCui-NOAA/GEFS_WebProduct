...
COMIN=/lfs/h2/emc/vpppg/noscrub/yan.luo/COM_TAR/1.0d
COMOUT=/lfs/h2/emc/vpppg/noscrub/yan.luo//daily_1deg_ccpav4
exec_dir=/lfs/h1/ops/para/packages/ccpa.v4.2.0/exec
tempdir=/lfs/h2/emc/ptmp/yan.luo/daily_ccpa_1deg
