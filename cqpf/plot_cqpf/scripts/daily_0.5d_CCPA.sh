...
COMIN=/lfs/h2/emc/vpppg/noscrub/yan.luo/COM_TAR/0.5d
COMOUT=/lfs/h2/emc/vpppg/noscrub/yan.luo/daily_0.5d_ccpav4
exec_dir=/lfs/h1/ops/para/packages/ccpa.v4.2.0/exec
tempdir=/lfs/h2/emc/ptmp/yan.luo/daily_ccpa_0.5d
